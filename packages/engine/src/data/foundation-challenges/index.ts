...
export const ALL_FOUNDATION_CHALLENGES: ReadonlyArray<FoundationChallengeDef> = [
  ...
  },
  {
    id: 'TRADE_EMPIRE',
    name: 'Trade Empire',
    description: 'Build 8 gold-category buildings across your empire.',
    category: 'economy',
    xp: 300,
  ...
  },
  {
    id: 'CRUSADE',
    name: 'Crusade',
    description: 'Win 15 combats and found 5 cities in a single game.',
    category: 'domination',
    xp: 400,
  ...
  },
  {
    id: 'INDUSTRIAL',
    name: 'Industrial',
    description: 'Build 20 buildings across your empire.',
    category: 'economy',
    xp: 350,
    condition: { type: 'buildings_built_at_least', count: 20 },
  },
  {
    ...
    description: 'Found 12 cities in a single game.',
    category: 'exploration',
    xp: 450,
    condition: { type: 'cities_at_least', count: 12 },
  },
  {
    id: 'SCIENTIFIC_REVOLUTION',
    name: 'Scientific Revolution',
    description: 'Research 15 technologies in a single game.',
    category: 'culture',
    xp: 350,
    condition: { type: 'techs_researched_at_least', count: 15 },
  },
  {
    id: 'IRON_FIST',
    name: 'Iron Fist',
    description: 'Win 25 combats in a single game.',
    category: 'domination',
    xp: 450,
    condition: { type: 'combat_wins_at_least', count: 25 },
  },
  {
    id: 'FORTIFICATION_MASTER',
    name: 'Fortification Master',
    description: 'Build 12 military-category buildings across your empire.',
    category: 'economy',
    xp: 300,
  ...
  },
  {
    ...
    description: 'Build 15 culture-category buildings and research 12 technologies.',
    category: 'culture',
    xp: 400,
