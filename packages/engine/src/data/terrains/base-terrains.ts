...
export const GRASSLAND: TerrainDef = {
  ...
  movementCost: 1,
  defenseBonus: 0,
  baseYields: { food: 2, production: 0, gold: 0, science: 0, culture: 0, faith: 0, influence: 0, housing: 0, diplomacy: 0 },
  isPassable: true,
  isWater: false,
  color: '#5c9e4a',
} as const;
...
export const PLAINS: TerrainDef = {
  ...
  movementCost: 1,
  defenseBonus: 0,
  baseYields: { food: 1, production: 1, gold: 0, science: 0, culture: 0, faith: 0, influence: 0, housing: 0, diplomacy: 0 },
  isPassable: true,
  isWater: false,
  color: '#a8b84e',
} as const;
