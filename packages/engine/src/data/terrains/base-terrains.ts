...
export const COAST: TerrainDef = {
  ...
  movementCost: 1,
  defenseBonus: 0,
  baseYields: { food: 1, production: 0, gold: 1, science: 0, culture: 0, faith: 0, influence: 0, happiness: 0 },
...
export const RAINFOREST: TerrainDef = {
  ...
  defenseBonus: 0.15,
  baseYields: { food: 1, production: 2, gold: 0, science: 1, culture: 0, faith: 0, influence: 0, happiness: 0 },
  isPassable: true,
  isWater: false,
  color: '#1e6b1a',
  biome: 'tropical',
