...
const PANEL_ID: PanelId = 'turnSummary';
  ...
  return (
    <PanelShell id={PANEL_ID} title="Turn Summary" onClose={onClose} priority="modal">
      ...
      {(summary.starvingCities.length > 0 || summary.unhappyCities > 0 || summary.goldPerTurn < -5) && (
        <div className="px-3 py-3 mb-3 -mx-1 rounded" style={{ borderBottom: '1px solid var(--color-border)', backgroundColor: 'rgba(255, 100, 100, 0.1)' }}>
