...
| WF-AUTO-14 | Workflow self-documentation refactor. | user request 2026-04-17 | **DONE** — 2026-04-17. 12 commits across BACKLOG cleanup, skill-description triggers, engine-patterns.md, principles.md (index), coordination.md, continuation directive, unified inject-rules/session-start with JSON validation + ~5.6k-token budget, commit-review PRINCIPLE-GAP step, MANIFEST.md, YAML headers on all .md, /audit-workflow skill. Post-refactor `/audit-workflow` returns CLEAN on 45 active files. |
