...
- `.claude/workflow/design/ui-review/08-master-plan.md` section 3.3
- `.claude/workflow/design/ui-review/phase-4-chrome-skeptic.md` section 7 (per-turn impact argument)
- `.claude/rules/ui-overlays.md` - HUD manager + TooltipShell rules; notifications are HUD
- `.claude/rules/engine-patterns.md` section 1 - immutable append to `state.log`
- `.claude/rules/panels.md` - `PanelId` union + `openPanel` contract
