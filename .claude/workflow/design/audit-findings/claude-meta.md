...
**Date:** 2026-04-15
**Scope:** `.claude/rules/*.md` (7), `.claude/skills/*/SKILL.md` (7), `.claude/hooks/*.sh` (6),
`.claude/workflow/*.md` + `.claude/workflow/design/*.md`, `.claude/settings*.json`,
...
**File:** `.claude/skills/add-hud-element/SKILL.md`, Step 3 (lines ~57–76)
...
**File:** `.claude/skills/add-hud-element/SKILL.md`, Step 1 type table (lines ~38–39)
...
**File:** `.claude/skills/add-panel/SKILL.md`, Step 3 (lines ~62–66)
...
**File:** `.claude/skills/add-panel/SKILL.md`, Step 7 smoke test (line ~133)
...
**File:** `.claude/hooks/check-edited-file.sh`, lines 38 (the regex matching system names)
...
**File:** `.claude/workflow/design/hud-ui-audit.md`
...
**File:** `.claude/workflow/design/panel-manager-audit.md`
...
**File:** `.claude/workflow/audit-status.md`
...
**File:** `.claude/hooks/log-bash-failure.sh`
