...
**Target worktree:** `.claude/worktrees/agent-aed22427`
...
Tech conventions (`.claude/rules/tech-conventions.md`) say "Tailwind
...
* Touch the canvas renderer, the engine, or any system. Import
  boundaries (`.claude/rules/import-boundaries.md`) say `ui/` cannot
