...
## S-ENGINE-PURE
Source: .claude/rules/architecture.md, .claude/rules/tech-conventions.md, .claude/rules/import-boundaries.md, CLAUDE.md
...
Severity: critical (PostToolUse hook enforced via .claude/hooks/check-edited-file.sh)
...
## S-DATA-PURE
Source: .claude/rules/architecture.md, .claude/rules/data-driven.md, .claude/rules/import-boundaries.md
...
## S-REGISTRY-PATTERN
Source: .claude/rules/architecture.md, .claude/rules/data-driven.md
...
Source: .claude/rules/architecture.md, .claude/rules/tech-conventions.md, CLAUDE.md
...
## S-SEEDED-RNG
Source: .claude/rules/architecture.md, .claude/rules/tech-conventions.md, .claude/rules/testing.md
...
## S-PANEL-PATTERN
Source: .claude/rules/panels.md, CLAUDE.md
...
## S-HUD-PATTERN
Source: .claude/rules/ui-overlays.md, CLAUDE.md
...
## S-IMPORT-BOUNDARIES
Source: .claude/rules/import-boundaries.md, CLAUDE.md
...
Detection: See .claude/hooks/check-edited-file.sh for full enforcement script.
Severity: critical (hook enforced)
...
## S-READONLY
Source: .claude/rules/tech-conventions.md, .claude/rules/architecture.md
...
## S-TESTS-L1
Source: .claude/rules/testing.md, .claude/workflow/CLAUDE.md
...
## S-DETERMINISM
Source: .claude/rules/testing.md, .claude/rules/tech-conventions.md
...
Source: .claude/rules/tech-conventions.md, .claude/rules/panels.md, .claude/rules/ui-overlays.md
...
Detection: grep python3  inside .claude/hooks/*.sh and CLAUDE.md.
Severity: medium

---

## S-NO-BOOLEAN-PANEL-STATE
Source: .claude/rules/panels.md
...
## S-ESC-OWNERSHIP-HUD
Source: .claude/rules/ui-overlays.md
...
## S-NO-RAW-HEX-CHROME
Source: .claude/rules/panels.md, .claude/rules/ui-overlays.md
...
Source: .claude/rules/data-driven.md, CLAUDE.md
...
## S-HUD-REGISTRATION
Source: .claude/rules/ui-overlays.md, .claude/workflow/design/hud-elements.md
Rule: Every HUD element must: (1) add id to HUDElementId union in hudRegistry.ts; (2) add entry to HUD_REGISTRY with priority and optional timeout; (3) update .claude/workflow/design/hud-elements.md with a row entry.
...
Source: .claude/rules/architecture.md, .claude/rules/tech-conventions.md
...
Source: CLAUDE.md, .claude/rules/architecture.md
