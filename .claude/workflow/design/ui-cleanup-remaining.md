...
- **(B)** Game-data display (faction/player colors, yield-dot palette,
  ...
  `.claude/rules/panels.md` and `.claude/rules/ui-overlays.md`, acceptable.
...
- `.claude/rules/panels.md`
- `.claude/rules/ui-overlays.md`
- `.claude/workflow/design/panel-manager-audit.md`
