...
**Reminder:** the reason we dropped the corner ornament in Phase 4 was clipping at narrow viewport (320px width). If you re-add, test at `standard`/`wide`/`ultra` first. See `.claude/workflow/design/ui-review/phase-4-chrome-skeptic.md` §4 for the failure modes to avoid.
...
- `.claude/rules/panels.md` — `PanelShell` tokens-only chrome rule
- `.claude/rules/ui-overlays.md` — HUD tokens-only chrome rule
- `.claude/workflow/design/ui-review/phase-1-design-tokens-spec.md` — palette rationale
- `.claude/workflow/design/ui-review/phase-4-chrome-pragmatist.md` + `phase-4-chrome-skeptic.md` — Phase 4 chrome direction (what shipped, what didn't, why)
- `.claude/workflow/design/ui-review/09-asset-pipeline.md` — the asset pipeline's origin spec
