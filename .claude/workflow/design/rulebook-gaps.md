...
- `.claude/workflow/design/civ7-rulebook.md` (full read, 920 lines)
- `.claude/workflow/design/civ7-accuracy-plan.md` (full read, 127 lines)
- `.claude/workflow/design/gap-analysis-v3.md` (full read, 96 lines)
- `.claude/workflow/design/gap-analysis-v2.md` (skim, cross-reference)
- `.claude/workflow/design/gap-analysis.md` (skim)
- `.claude/workflow/design/ai-overhaul.md` (skim for context)
- `.claude/workflow/design/phase1-terrain-map.md` (skim for context)
- `.claude/workflow/design/review-iteration-1.md` (skim)
- `.claude/workflow/design/selection-system.md` (skim)
- `.claude/workflow/design/ux-review.md` (skim)
