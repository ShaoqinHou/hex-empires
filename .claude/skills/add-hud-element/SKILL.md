...
description: Step-by-step guide for adding a new hover tooltip, notification, validation feedback, or hint overlay that conforms to the HUDManager + TooltipShell pattern
user_invocable: true
---
