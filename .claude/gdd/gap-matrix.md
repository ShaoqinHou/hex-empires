...
| 25 | **legends** | — | MISSING | LOW | No meta-progression layer in engine (deliberate — CLAUDE.md notes "Achievements parked behind `experimentalAchievements` flag"). Low priority. |
...
2. Read the corresponding GDD system doc (`.claude/gdd/systems/[slug].md`) in full.
