...
**Status tally:** 1 MATCH / 4CLOSE / 2 DIVERGED / 5 MISSING / 1 EXTRA
**Audit:** [.claude/gdd/audits/diplomacy-influence.md](../audits/diplomacy-influence.md)
**Highest-severity finding:** F-02 — Influence generation sources (DIVERGED, HIGH)
