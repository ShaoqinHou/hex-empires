...
**Status tally:** 4 MATCH / 2CLOSE / 5 DIVERGED / 2 MISSING / 1 EXTRA
**Audit:** [.claude/gdd/audits/combat.md](../audits/combat.md)
...
_(Full details in audit file. 14 total finding(s). Regenerated by `.claude/scripts/aggregate-audits.py`.)_
