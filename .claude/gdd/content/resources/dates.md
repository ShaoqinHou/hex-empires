...
Desert palm fruit, a North African luxury.

## Stats / numeric attributes

- **Type:** `bonus` resource
- **Age(s) available:** Antiquity + Exploration
- **Terrain spawn:** desert/oasis
- **Yield / Effect:** Ant: +2 Food, +2 Happiness; Expl: +3 Food, +3 Happiness
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Ant: +2 Food, +2 Happiness; Expl: +3 Food, +3 Happiness"
```
