...
Gulf pearl diving; prized luxury across cultures.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** coastal reef
- **Yield / Effect:** Ant: +2 Hap Capital; Expl: +3 Hap Homeland; Mod: +6 Hap Capital
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "Ant: +2 Hap Capital; Expl: +3 Hap Homeland; Mod: +6 Hap Capital"
```
