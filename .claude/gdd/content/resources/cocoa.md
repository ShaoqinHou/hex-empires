...
Mesoamerican origin; European chocolate industrialization.
...
- **Yield / Effect:** Expl: Creates Treasure Fleets; Mod: +3% Happiness (Factory slot)
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "Expl: Creates Treasure Fleets; Mod: +3% Happiness (Factory slot)"
