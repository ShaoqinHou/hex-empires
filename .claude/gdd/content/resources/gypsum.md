...
Plaster and construction stone.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Antiquity + Exploration
- **Terrain spawn:** hills/desert
- **Yield / Effect:** Ant: +2 Prod Capital; Expl: +3 Prod Homeland
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "Ant: +2 Prod Capital; Expl: +3 Prod Homeland"
```
