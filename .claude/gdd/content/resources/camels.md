...
Desert beast of burden; trans-Saharan and Silk Road transport.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Exploration + Modern
- **Terrain spawn:** desert
- **Yield / Effect:** +2 to Resource Capacity per City
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "+2 to Resource Capacity per City"
```
