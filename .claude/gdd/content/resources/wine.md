...
Viticulture; Mediterranean and Near Eastern trade.

## Stats / numeric attributes

- **Type:** `bonus` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** mediterranean
- **Yield / Effect:** Ant: +2 Happiness Capital + 10% Culture; Expl: +3 Happiness Capital; Mod: +4 Food, +4 Prod
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Ant: +2 Happiness Capital + 10% Culture; Expl: +3 Happiness Capital; Mod: +4 Food, +4 Prod"
```
