...
Saltpeter for gunpowder; strategic explosive resource.
...
- **Yield / Effect:** Expl: +1 CS Siege+Naval; Mod: +1 CS Ranged+Siege
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "Expl: +1 CS Siege+Naval; Mod: +1 CS Ranged+Siege"
```
