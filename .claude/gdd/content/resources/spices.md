...
The spice trade drove European colonial expansion.
...
- **Yield / Effect:** Expl: Creates Treasure Fleets (coastal); Mod: +4 Food, +4 Happiness
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Expl: Creates Treasure Fleets (coastal); Mod: +4 Food, +4 Happiness"
