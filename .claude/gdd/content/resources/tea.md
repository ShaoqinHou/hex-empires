...
Chinese and Indian tea trade; British imperial monopoly.

## Stats / numeric attributes

- **Type:** `factory` resource
- **Age(s) available:** Exploration + Modern
- **Terrain spawn:** tropical/hills
- **Yield / Effect:** Expl: Creates Treasure Fleets; Mod: +3% Science (Factory slot)
- **Distant Lands exclusive:** yes (5-resource Treasure Fleet pool)
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "Expl: Creates Treasure Fleets; Mod: +3% Science (Factory slot)"
  - type: DISTANT_LANDS_EXCLUSIVE
    enabled: true
```
