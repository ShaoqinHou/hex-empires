...
Frankincense and myrrh; Arabian and East African trade.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Antiquity + Exploration
- **Terrain spawn:** desert/tropical
- **Yield / Effect:** Ant: +10% Science; Expl: +100% Prod to Missionaries/Temples
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "Ant: +10% Science; Expl: +100% Prod to Missionaries/Temples"
```
