...
Iron age military and industrial foundation.

## Stats / numeric attributes

- **Type:** `empire` resource
- **Age(s) available:** Antiquity + Exploration
- **Terrain spawn:** hills/mountains
- **Yield / Effect:** Ant: +1 CS Infantry; Expl: +1 CS Infantry+Ranged
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "Ant: +1 CS Infantry; Expl: +1 CS Infantry+Ranged"
```
