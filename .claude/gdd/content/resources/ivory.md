...
Elephant and walrus tusk carvings prized across empires.

## Stats / numeric attributes

- **Type:** `bonus` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** tropical/plains/desert
- **Yield / Effect:** Ant: +10% Wonder Prod; Expl: +3 Happiness, +3 Prod; Mod: +4 Happiness, +4 Prod
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Ant: +10% Wonder Prod; Expl: +3 Happiness, +3 Prod; Mod: +4 Happiness, +4 Prod"
```
