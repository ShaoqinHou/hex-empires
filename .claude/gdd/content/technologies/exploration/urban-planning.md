...
- Unlocks: Bank, Hospital, Machu Picchu
- Mastery reward: +1 Specialist Limit in all Cities
...
effects:
  - type: UNLOCK
    items: "Bank, Hospital, Machu Picchu"
  - type: MASTERY_REWARD
    effect: "+1 Specialist Limit in all Cities"
```
