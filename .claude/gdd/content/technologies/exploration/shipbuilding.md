...
- Age: exploration
- Prerequisite: Heraldry
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Shipyard, Carrack
- Mastery reward: All Naval Units deep ocean safe, +3 CS Naval
...
effects:
  - type: UNLOCK
    items: "Shipyard, Carrack"
  - type: MASTERY_REWARD
    effect: "All Naval Units deep ocean safe, +3 CS Naval"
```
