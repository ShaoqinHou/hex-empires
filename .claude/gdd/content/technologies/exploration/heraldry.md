...
- Age: exploration
- Prerequisite: Machinery + Astronomy
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Knight, Man-At-Arms, Mamluk
- Mastery reward: +3 CS Infantry, +1 Happiness on Happiness Buildings
...
effects:
  - type: UNLOCK
    items: "Knight, Man-At-Arms, Mamluk"
  - type: MASTERY_REWARD
    effect: "+3 CS Infantry, +1 Happiness on Happiness Buildings"
```
