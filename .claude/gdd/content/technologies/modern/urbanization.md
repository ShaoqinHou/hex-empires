...
- Age: modern
- Prerequisite: Academics + Steam Engine
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Department Store, Opera House, Modern Bridge
- Mastery reward: +1 Settlement Limit, +1 Prod on Clay Pits/Quarries
...
effects:
  - type: UNLOCK
    items: "Department Store, Opera House, Modern Bridge"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit, +1 Prod on Clay Pits/Quarries"
```
