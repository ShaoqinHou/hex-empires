...
- Unlocks: Laboratory, Stock Exchange
- Mastery reward: +1 Specialist Limit, +1 Gold on Gold Buildings, +1 Science on Science Buildings
...
effects:
  - type: UNLOCK
    items: "Laboratory, Stock Exchange"
  - type: MASTERY_REWARD
    effect: "+1 Specialist Limit, +1 Gold on Gold Buildings, +1 Science on Science Buildings"
```
