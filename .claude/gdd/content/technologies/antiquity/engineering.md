...
- Age: antiquity
- Prerequisite: Currency + Bronze Working
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Amphitheater, Blacksmith, Ancient Bridge
- Mastery reward: +1 Culture on Culture Buildings, 1 Codex
...
effects:
  - type: UNLOCK
    items: "Amphitheater, Blacksmith, Ancient Bridge"
  - type: MASTERY_REWARD
    effect: "+1 Culture on Culture Buildings, 1 Codex"
```
