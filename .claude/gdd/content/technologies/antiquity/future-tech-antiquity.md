# Future Tech (Antiquity) - Civ VII

**Slug:** `future-tech-antiquity`
**Category:** `technology`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- Age: antiquity
- Prerequisite: Mathematics + Iron Working
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: +10 Age Progress, +1 Wildcard Attribute Point, next-age boost
...
effects:
  - type: UNLOCK
    items: "+10 Age Progress, +1 Wildcard Attribute Point, next-age boost"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
