...
- Age: antiquity
- Prerequisite: Sailing + Pottery
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Library, Great Stele (Wonder)
- Mastery reward: 1 Codex, Steal Technology espionage
...
effects:
  - type: UNLOCK
    items: "Library, Great Stele (Wonder)"
  - type: MASTERY_REWARD
    effect: "1 Codex, Steal Technology espionage"
```
