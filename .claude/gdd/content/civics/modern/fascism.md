...
A Modern-Age civic in Civ VII's per-age civic tree. Ideology: the total state.
...
- Unlocks: Assembly Line, Dirigisme, +3 Cavalry, +1 Eco/Mil Attribute
...
effects:
  - type: UNLOCK
    items: "Assembly Line, Dirigisme, +3 Cavalry, +1 Eco/Mil Attribute"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
