# Wartime Manufacturing - Civ VII

**Slug:** `wartime-manufacturing`
**Category:** `civic`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: america.** A Modern-Age civic in Civ VII's per-age civic tree. Arsenal of Democracy.

## Stats / numeric attributes

- Age: modern
- Cost (Culture): 3000
- Prerequisite: captains-of-industry, yankee-ingenuity
- Unlocks: +3 Combat per adjacent enemy
- Mastery reward: +25% Production in favorable wars, Lend-Lease
- Civ-unique: YES (america only)
...
effects:
  - type: UNLOCK
    items: "+3 Combat per adjacent enemy"
  - type: MASTERY_REWARD
    effect: "+25% Production in favorable wars, Lend-Lease"
```
