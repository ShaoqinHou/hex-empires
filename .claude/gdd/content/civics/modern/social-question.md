# Social Question - Civ VII

**Slug:** `social-question`
**Category:** `civic`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
A Modern-Age civic in Civ VII's per-age civic tree. The question of labor and reform.
...
- Cost (Culture): 1600
- Prerequisite: none
- Unlocks: Humanism, Social Science, Dogo Onsen
...
effects:
  - type: UNLOCK
    items: "Humanism, Social Science, Dogo Onsen"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
