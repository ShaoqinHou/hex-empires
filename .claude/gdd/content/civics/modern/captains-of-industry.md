# Captains of Industry - Civ VII

**Slug:** `captains-of-industry`
**Category:** `civic`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: america.** A Modern-Age civic in Civ VII's per-age civic tree. Industrial tycoons.
...
- Mastery reward: +2 Production on Resources, +1 Settlement Limit
...
effects:
  - type: UNLOCK
    items: "Railyard building"
  - type: MASTERY_REWARD
    effect: "+2 Production on Resources, +1 Settlement Limit"
```
