...
**Civ-unique: mughal.** A Modern-Age civic in Civ VII's per-age civic tree. Rank-and-salary military nobility.
...
- Cost (Culture): 3000
- Prerequisite: zabt
- Unlocks: Gold toward purchasing Infantry
- Mastery reward: Red Fort wonder
- Civ-unique: YES (mughal only)
...
effects:
  - type: UNLOCK
    items: "Gold toward purchasing Infantry"
  - type: MASTERY_REWARD
    effect: "Red Fort wonder"
```
