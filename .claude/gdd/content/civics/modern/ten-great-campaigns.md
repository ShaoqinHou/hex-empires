# Ten Great Campaigns - Civ VII

**Slug:** `ten-great-campaigns`
**Category:** `civic`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: qing.** A Modern-Age civic in Civ VII's per-age civic tree. Qianlong frontier expeditions.
...
- Cost (Culture): 2000
- Prerequisite: none
- Unlocks: +1 Combat per trade-routed Civ/City-State
- Mastery reward: `[none listed]`
- Civ-unique: YES (qing only)
...
effects:
  - type: UNLOCK
    items: "+1 Combat per trade-routed Civ/City-State"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
