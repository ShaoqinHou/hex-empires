...
A Modern-Age civic in Civ VII's per-age civic tree. Collective ownership under party.
...
- Unlocks: Defense of Motherland, Police State, Public Works
...
effects:
  - type: UNLOCK
    items: "Defense of Motherland, Police State, Public Works"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
