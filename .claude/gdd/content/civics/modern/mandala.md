...
**Civ-unique: siam.** A Modern-Age civic in Civ VII's per-age civic tree. Concentric-ring polity.

## Stats / numeric attributes

- Age: modern
- Cost (Culture): 3000
- Prerequisite: nine-gems
- Unlocks: Chang Beun +6 Combat near suzerain City-States
- Mastery reward: Doi Suthep, +3 Culture on Palace per City-State
- Civ-unique: YES (siam only)
...
effects:
  - type: UNLOCK
    items: "Chang Beun +6 Combat near suzerain City-States"
  - type: MASTERY_REWARD
    effect: "Doi Suthep, +3 Culture on Palace per City-State"
```
