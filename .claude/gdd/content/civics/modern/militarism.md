...
A Modern-Age civic in Civ VII's per-age civic tree. State as armed fist.
...
- Unlocks: Materiel, Trenchworks
- Mastery reward: Draft, Projection of Force, Brandenburg Gate
...
effects:
  - type: UNLOCK
    items: "Materiel, Trenchworks"
  - type: MASTERY_REWARD
    effect: "Draft, Projection of Force, Brandenburg Gate"
```
