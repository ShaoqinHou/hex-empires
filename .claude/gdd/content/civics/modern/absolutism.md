...
A Modern-Age civic in Civ VII's per-age civic tree. Unchecked executive power.
...
- Unlocks: Military-Industrial Complex, Strategic Railways, Scorched Earth
...
effects:
  - type: UNLOCK
    items: "Military-Industrial Complex, Strategic Railways, Scorched Earth"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
