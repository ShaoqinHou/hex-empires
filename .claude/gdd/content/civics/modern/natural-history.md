...
A Modern-Age civic in Civ VII's per-age civic tree. Artifact collection (Cultural Victory gate).
...
- Cost (Culture): 1600
- Prerequisite: none
- Unlocks: Explorer, Land Heritage, Museum
...
effects:
  - type: UNLOCK
    items: "Explorer, Land Heritage, Museum"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
