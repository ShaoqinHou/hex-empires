# Future Civic (Antiquity) - Civ VII

**Slug:** `future-civic-antiquity`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
A Antiquity-Age civic in Civ VII's per-age civic tree. Repeatable end-of-tree node.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 1000
- Prerequisite: philosophy, commerce
