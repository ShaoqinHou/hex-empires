...
A Antiquity-Age civic in Civ VII's per-age civic tree. Formation combat; tactical reserves.
...
- Unlocks: Drills policy, Terracotta Army wonder
...
effects:
  - type: UNLOCK
    items: "Drills policy, Terracotta Army wonder"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
