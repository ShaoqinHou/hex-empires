...
A Antiquity-Age civic in Civ VII's per-age civic tree. Trained soldiers; unlocks commanders.
...
- Unlocks: Survey policy, Dur-Sharrukin wonder, Army Commander
- Mastery reward: Honor policy, Gate of All Nations wonder
...
effects:
  - type: UNLOCK
    items: "Survey policy, Dur-Sharrukin wonder, Army Commander"
  - type: MASTERY_REWARD
    effect: "Honor policy, Gate of All Nations wonder"
```
