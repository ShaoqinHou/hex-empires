...
A Antiquity-Age civic in Civ VII's per-age civic tree. Defined civic rights; cultural output.
...
- Unlocks: Cultural Festival, Weiyang Palace, Drama/Poetry, Castes
- Mastery reward: Wonder Construction, Sanchi Stupa, Hospitality
...
effects:
  - type: UNLOCK
    items: "Cultural Festival, Weiyang Palace, Drama/Poetry, Castes"
  - type: MASTERY_REWARD
    effect: "Wonder Construction, Sanchi Stupa, Hospitality"
```
