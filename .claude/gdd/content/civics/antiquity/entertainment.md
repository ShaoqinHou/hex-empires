...
A Antiquity-Age civic in Civ VII's per-age civic tree. Spectacle binds citizens to the state.
...
- Unlocks: Rites and Rituals policy, Colosseum, +1 Settlement Limit
...
effects:
  - type: UNLOCK
    items: "Rites and Rituals policy, Colosseum, +1 Settlement Limit"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
