...
**Civ-unique: greece.** A Antiquity-Age civic in Civ VII's per-age civic tree. Alliance webs knit the Aegean.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 250
- Prerequisite: ekklesia
- Unlocks: +2 Culture per City-State suzerainty, +1 Settlement Limit, Oracle
- Mastery reward: Delian/Peloponnesian League traditions
- Civ-unique: YES (greece only)
...
effects:
  - type: UNLOCK
    items: "+2 Culture per City-State suzerainty, +1 Settlement Limit, Oracle"
  - type: MASTERY_REWARD
    effect: "Delian/Peloponnesian League traditions"
```
