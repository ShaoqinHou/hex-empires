...
A Antiquity-Age civic in Civ VII's per-age civic tree. Systematic inquiry; the examined life.
...
- Unlocks: Scholars policy, Angkor Wat, +1 Policy Slot
...
effects:
  - type: UNLOCK
    items: "Scholars policy, Angkor Wat, +1 Policy Slot"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
