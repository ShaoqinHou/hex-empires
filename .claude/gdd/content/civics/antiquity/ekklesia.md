...
**Civ-unique: greece.** A Antiquity-Age civic in Civ VII's per-age civic tree. The citizen assembly convenes.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Odeon building, Xenia tradition
- Mastery reward: +2 Culture for active Endeavors
...
effects:
  - type: UNLOCK
    items: "Odeon building, Xenia tradition"
  - type: MASTERY_REWARD
    effect: "+2 Culture for active Endeavors"
```
