...
**Civ-unique: maurya.** A Antiquity-Age civic in Civ VII's per-age civic tree. The teacher as civic cornerstone.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Dharmashala, Vihara, Charvaka tradition
...
effects:
  - type: UNLOCK
    items: "Dharmashala, Vihara, Charvaka tradition"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
