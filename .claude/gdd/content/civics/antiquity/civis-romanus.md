...
**Civ-unique: rome.** A Antiquity-Age civic in Civ VII's per-age civic tree. Citizenship as portable legal status.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Basilica building, Cursus Honorum tradition
- Mastery reward: +2 Gold in Capital per Town
...
effects:
  - type: UNLOCK
    items: "Basilica building, Cursus Honorum tradition"
  - type: MASTERY_REWARD
    effect: "+2 Gold in Capital per Town"
```
