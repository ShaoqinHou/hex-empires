...
A Antiquity-Age civic in Civ VII's per-age civic tree. Written record preserves knowledge.
...
- Unlocks: Literature policy, Nalanda wonder, 1 Codex
...
effects:
  - type: UNLOCK
    items: "Literature policy, Nalanda wonder, 1 Codex"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
