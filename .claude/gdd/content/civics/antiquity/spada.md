...
**Civ-unique: persia.** A Antiquity-Age civic in Civ VII's per-age civic tree. The Immortals stand ready.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: -1 Military Unit maintenance, Kara tradition
...
effects:
  - type: UNLOCK
    items: "-1 Military Unit maintenance, Kara tradition"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
