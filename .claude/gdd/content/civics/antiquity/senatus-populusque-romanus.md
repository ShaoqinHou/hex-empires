# Senatus Populusque Romanus - Civ VII

**Slug:** `senatus-populusque-romanus`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: rome.** A Antiquity-Age civic in Civ VII's per-age civic tree. SPQR - Senate and People of Rome.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 400
- Prerequisite: civis-romanus
- Unlocks: +1 Social Policy slot, +1 Settlement Limit, Colosseum
...
effects:
  - type: UNLOCK
    items: "+1 Social Policy slot, +1 Settlement Limit, Colosseum"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
