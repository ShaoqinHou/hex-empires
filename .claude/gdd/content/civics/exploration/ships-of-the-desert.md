# Ships of the Desert - Civ VII

**Slug:** `ships-of-the-desert`
**Category:** `civic`
**Age:** `exploration`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: songhai.** A Exploration-Age civic in Civ VII's per-age civic tree. Camel caravans bind Sahelian trade.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: Caravanserai improvement, Tomb of Askia
- Mastery reward: Mud Brick, Caravanserai +2 Gold with Bazaar
- Civ-unique: YES (songhai only)
...
effects:
  - type: UNLOCK
    items: "Caravanserai improvement, Tomb of Askia"
  - type: MASTERY_REWARD
    effect: "Mud Brick, Caravanserai +2 Gold with Bazaar"
```
