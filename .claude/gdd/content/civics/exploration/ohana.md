...
**Civ-unique: hawaii.** A Exploration-Age civic in Civ VII's per-age civic tree. Family as unit of belonging.
...
- Mastery reward: +2 Culture for Lo-i Kalo with Pavilion
...
effects:
  - type: UNLOCK
    items: "Lo'i Kalo improvement"
  - type: MASTERY_REWARD
    effect: "+2 Culture for Lo-i Kalo with Pavilion"
```
