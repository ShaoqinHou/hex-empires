...
**Civ-unique: chola.** A Exploration-Age civic in Civ VII's per-age civic tree. Merchant guilds run the ports.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: +50% Influence to Improve Trade Relations
- Mastery reward: +2 Resource Capacity in Capital
...
effects:
  - type: UNLOCK
    items: "+50% Influence to Improve Trade Relations"
  - type: MASTERY_REWARD
    effect: "+2 Resource Capacity in Capital"
```
