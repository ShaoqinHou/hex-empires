...
A Exploration-Age civic in Civ VII's per-age civic tree. Organized devotion; gates religion founding.
...
- Cost (Culture): 700
- Prerequisite: none
- Unlocks: Commune policy, Temple; gates religion
...
effects:
  - type: UNLOCK
    items: "Commune policy, Temple; gates religion"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
