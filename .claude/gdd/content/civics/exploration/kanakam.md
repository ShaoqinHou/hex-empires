...
**Civ-unique: chola.** A Exploration-Age civic in Civ VII's per-age civic tree. Gold as language of diplomacy.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 1200
- Prerequisite: nagaram
- Unlocks: +1 Gold from active Diplomatic Actions
...
effects:
  - type: UNLOCK
    items: "+1 Gold from active Diplomatic Actions"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
