...
**Civ-unique: abbasid.** A Exploration-Age civic in Civ VII's per-age civic tree. Algebra as state science.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 1200
- Prerequisite: round-city
- Unlocks: +15% Science in Cities with 8+ Urban Pop
- Mastery reward: House of Wisdom
...
effects:
  - type: UNLOCK
    items: "+15% Science in Cities with 8+ Urban Pop"
  - type: MASTERY_REWARD
    effect: "House of Wisdom"
```
