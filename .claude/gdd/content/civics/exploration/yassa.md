...
**Civ-unique: mongolia.** A Exploration-Age civic in Civ VII's per-age civic tree. The code of Chinggis binds the steppe.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 2000
- Prerequisite: four-hounds
- Unlocks: Ortoo +4 Gold in non-founded Settlements
...
effects:
  - type: UNLOCK
    items: "Ortoo +4 Gold in non-founded Settlements"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
