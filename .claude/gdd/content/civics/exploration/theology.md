...
A Exploration-Age civic in Civ VII's per-age civic tree. Systematic doctrine of the divine.
...
- Cost (Culture): 1300
- Prerequisite: piety
- Unlocks: Religion founding branch
...
effects:
  - type: UNLOCK
    items: "Religion founding branch"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
