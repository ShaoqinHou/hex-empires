...
A Exploration-Age civic in Civ VII's per-age civic tree. Resident envoys and formal protocol.
...
- Unlocks: Heqin policy, Brihadeeswarar Temple, +1 Policy Slot
...
effects:
  - type: UNLOCK
    items: "Heqin policy, Brihadeeswarar Temple, +1 Policy Slot"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
