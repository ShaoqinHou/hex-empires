...
**Civ-unique: hawaii.** A Exploration-Age civic in Civ VII's per-age civic tree. Spiritual power channeled through island life.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: +2 Culture per Storm/Flood/Eruption Fertility this Age
- Mastery reward: Leiomano culture gain from defeats
...
effects:
  - type: UNLOCK
    items: "+2 Culture per Storm/Flood/Eruption Fertility this Age"
  - type: MASTERY_REWARD
    effect: "Leiomano culture gain from defeats"
```
