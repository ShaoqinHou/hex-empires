...
A Exploration-Age civic in Civ VII's per-age civic tree. Distant settlements under metropolitan control.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 1300
- Prerequisite: mercantilism
- Unlocks: Charters policy, Colonial Surplus
- Mastery reward: El Escorial, +1 Settlement Limit
...
effects:
  - type: UNLOCK
    items: "Charters policy, Colonial Surplus"
  - type: MASTERY_REWARD
    effect: "El Escorial, +1 Settlement Limit"
```
