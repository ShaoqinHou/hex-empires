...
**Civ-unique: inca.** A Exploration-Age civic in Civ VII's per-age civic tree. Rotational labor service.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: Terrace Farm improvement
- Mastery reward: Machu Picchu wonder
...
effects:
  - type: UNLOCK
    items: "Terrace Farm improvement"
  - type: MASTERY_REWARD
    effect: "Machu Picchu wonder"
```
