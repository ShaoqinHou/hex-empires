# At the World's Edge - Civ VII

**Slug:** `starting-in-tundra`
...
Northern civilizations historically combined fishing, reindeer herding, and trade.

## Stats / numeric attributes

- **Trigger type:** starting-tile
- **Trigger condition:** Capital founded on Tundra biome
- **Age:** antiquity
- **Options:** 2 choices

## Choice effects

- **A: Hardy people:** +10% Growth rate despite harsh climate
- **B: Hunter traditions:** +2 Food per Pasture in Tundra
...
triggers:
  - type: starting-tile
    condition: "Capital founded on Tundra biome"
