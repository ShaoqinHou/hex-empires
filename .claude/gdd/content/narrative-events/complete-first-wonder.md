# The Wonder Rises - Civ VII

**Slug:** `complete-first-wonder`
...
First wonder construction marks civilization's ambition.

## Stats / numeric attributes

- **Trigger type:** wonder-completion
- **Trigger condition:** First Wonder constructed
- **Age:** antiquity
- **Options:** 2 choices

## Choice effects

- **A: Dedicate to the gods:** +5 Faith/turn for 10 turns
- **B: Dedicate to the people:** +5 Happiness empire-wide for 10 turns

## Unique effects (structured)

```yaml
triggers:
  - type: wonder-completion
    condition: "First Wonder constructed"
