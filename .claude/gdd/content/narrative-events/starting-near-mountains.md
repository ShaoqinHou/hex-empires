# Shadowed by the Mountains - Civ VII

**Slug:** `starting-near-mountains`
...
Mountain-adjacent settlements historically built on strong defensive positions.

## Stats / numeric attributes

- **Trigger type:** starting-tile
- **Trigger condition:** Capital founded adjacent to Mountain
- **Age:** antiquity
- **Options:** 2 choices

## Choice effects

- **A: Terrace the slopes:** +1 Food on Mountain-adjacent rural tiles
- **B: Defensive bastion:** +3 CS defending Capital
...
triggers:
  - type: starting-tile
    condition: "Capital founded adjacent to Mountain"
