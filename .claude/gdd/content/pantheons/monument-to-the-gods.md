# Monument to the Gods — Civ VII

**Slug:** `monument-to-the-gods`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +10% Production toward Wonders
...
Speeds wonder construction across the entire empire. Especially strong for Cultural Legacy Path (Wonders of the Ancient World) players targeting 7 wonders.
...
effects:
  - type: PANTHEON_BONUS
    description: "+10% Production toward Wonders"
    scope: empire
