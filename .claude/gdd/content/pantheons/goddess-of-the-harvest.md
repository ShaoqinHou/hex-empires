# Goddess of the Harvest — Civ VII

**Slug:** `goddess-of-the-harvest`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +1 Food on Farms, Pastures, and Plantations
...
Flat +1 Food across three of the most common rural improvements. Highest-value growth pantheon in pre-patch-1.1.2 metagames; still strong post-patch.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Food on Farms, Pastures, and Plantations"
    scope: empire
