...
- **Effect:** +5 healing for units on rural tiles
...
Units healing on a rural tile (Farm, Mine, etc.) recover +5 HP per turn. Extends front-line durability during Antiquity wars.
...
effects:
  - type: PANTHEON_BONUS
    description: "+5 healing for units on rural tiles"
    scope: empire
