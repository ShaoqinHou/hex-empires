...
- **Effect:** +1 Production on Clay Pits, Mines, and Quarries
...
Industrial pantheon — boosts the three primary Production rural improvements. Pairs well with mountain/hill-adjacent starts.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Production on Clay Pits, Mines, and Quarries"
    scope: empire
