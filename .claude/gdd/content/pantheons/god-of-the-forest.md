# God of the Forest — Civ VII

**Slug:** `god-of-the-forest`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +1 Gold on Camps and Woodcutters
...
Flat per-tile gold bonus for animal-resource and forest improvements. Strong on heavily forested starts.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Gold on Camps and Woodcutters"
    scope: empire
