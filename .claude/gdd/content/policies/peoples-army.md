...
- **Age:** modern
- **Unlock:** Nationalism Mastery
- **Effect:** +2 Combat Strength for Infantry

## Effect description

+2 Combat Strength for Infantry. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Combat Strength for Infantry"
