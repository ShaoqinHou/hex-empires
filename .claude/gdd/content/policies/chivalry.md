...
- **Age:** exploration
- **Unlock:** Social Class civic
- **Effect:** +3 Combat Strength for Cavalry

## Effect description

+3 Combat Strength for Cavalry. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+3 Combat Strength for Cavalry"
