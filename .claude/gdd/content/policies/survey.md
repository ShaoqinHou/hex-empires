...
- **Age:** antiquity
- **Unlock:** Discipline civic
- **Effect:** +10% Production toward Scout and military unit production

## Effect description

+10% Production toward Scout and military unit production. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+10% Production toward Scout and military unit production"
