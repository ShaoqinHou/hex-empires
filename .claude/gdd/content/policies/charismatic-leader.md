# Charismatic Leader - Civ VII

**Slug:** `charismatic-leader`
**Category:** `policy`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +2 Happiness in Capital

## Effect description

+2 Happiness in Capital. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Happiness in Capital"
