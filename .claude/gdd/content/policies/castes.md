...
Structured society roles.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Citizenship civic
- **Effect:** +1 Production per Quarter

## Effect description

+1 Production per Quarter. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Production per Quarter"
