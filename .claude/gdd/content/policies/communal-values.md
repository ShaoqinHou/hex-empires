# Communal Values - Civ VII

**Slug:** `communal-values`
**Category:** `policy`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** antiquity
- **Unlock:** Public Life
- **Effect:** +1 Culture per Settlement

## Effect description

+1 Culture per Settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Culture per Settlement"
