# Prosecute Apostates - Civ VII

**Slug:** `prosecute-apostates`
**Category:** `policy`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** antiquity
- **Unlock:** Plague Stage 2
- **Effect:** -5 Happiness in Settlements without Altar; +5 Happiness in infected Settlements with Commander

## Effect description

-5 Happiness in Settlements without Altar; +5 Happiness in infected Settlements with Commander. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "-5 Happiness in Settlements without Altar; +5 Happiness in infected Settlements with Commander"
