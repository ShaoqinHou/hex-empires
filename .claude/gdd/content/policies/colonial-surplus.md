# Colonial Surplus - Civ VII

**Slug:** `colonial-surplus`
**Category:** `policy`
**Age:** `exploration`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** exploration
- **Unlock:** Colonialism Mastery
- **Effect:** +4 Gold per Distant Lands Settlement

## Effect description

+4 Gold per Distant Lands Settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+4 Gold per Distant Lands Settlement"
