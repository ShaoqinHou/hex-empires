...
- **Age:** modern
- **Unlock:** Democracy civic
- **Effect:** +3 Happiness per Radio Station

## Effect description

+3 Happiness per Radio Station. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+3 Happiness per Radio Station"
