...
Religious response to plague.

## Stats / numeric attributes

- **Category:** `crisis` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Plague crisis Stage 1
- **Effect:** -10 Gold on Altars in infected; +5 Happiness on Altars in infected

## Effect description

-10 Gold on Altars in infected; +5 Happiness on Altars in infected. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "-10 Gold on Altars in infected; +5 Happiness on Altars in infected"
