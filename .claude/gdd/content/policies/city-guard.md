...
- **Age:** antiquity
- **Unlock:** Public Life civic
- **Effect:** +5 Combat Strength defending in Districts

## Effect description

+5 Combat Strength defending in Districts. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+5 Combat Strength defending in Districts"
