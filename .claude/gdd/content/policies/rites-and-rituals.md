# Rites and Rituals - Civ VII

**Slug:** `rites-and-rituals`
**Category:** `policy`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** antiquity
- **Unlock:** Entertainment civic
- **Effect:** +1 Happiness during Celebrations

## Effect description

+1 Happiness during Celebrations. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Happiness during Celebrations"
