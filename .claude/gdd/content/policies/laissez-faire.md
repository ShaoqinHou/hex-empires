...
- **Age:** modern
- **Unlock:** Capitalism civic
- **Effect:** +20% Gold from Trade Routes

## Effect description

+20% Gold from Trade Routes. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+20% Gold from Trade Routes"
