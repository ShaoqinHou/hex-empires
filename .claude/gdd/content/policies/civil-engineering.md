...
- **Age:** modern
- **Unlock:** Modernization civic
- **Effect:** +20% Production toward Infrastructure

## Effect description

+20% Production toward Infrastructure. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+20% Production toward Infrastructure"
