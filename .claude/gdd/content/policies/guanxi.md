...
- **Age:** antiquity/ageless
- **Unlock:** Han civ
- **Effect:** Relationship-building bonuses

## Effect description

Relationship-building bonuses. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Relationship-building bonuses"
