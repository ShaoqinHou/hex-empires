...
- **Age:** modern
- **Unlock:** Social Class Modern
- **Effect:** +2 Gold per Bank; +1 Culture per Opera

## Effect description

+2 Gold per Bank; +1 Culture per Opera. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Gold per Bank; +1 Culture per Opera"
