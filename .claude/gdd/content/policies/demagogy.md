...
Populist war rhetoric.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** modern
- **Unlock:** Nationalism civic
- **Effect:** +5 Happiness during wartime

## Effect description

+5 Happiness during wartime. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+5 Happiness during wartime"
