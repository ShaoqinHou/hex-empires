# Port of Nations - Civ VII

**Slug:** `port-of-nations`
**Category:** `policy`
...
- **Age:** antiquity/ageless
- **Unlock:** Aksum civ
- **Effect:** Trade route yield bonus for coastal ports

## Effect description

Trade route yield bonus for coastal ports. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Trade route yield bonus for coastal ports"
