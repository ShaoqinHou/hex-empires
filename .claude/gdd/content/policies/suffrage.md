...
- **Age:** modern
- **Unlock:** Democracy
- **Effect:** +1 Policy Slot; +1 Culture per Settlement

## Effect description

+1 Policy Slot; +1 Culture per Settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Policy Slot; +1 Culture per Settlement"
