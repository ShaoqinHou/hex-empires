...
- **Age:** antiquity/ageless
- **Unlock:** Maurya civ
- **Effect:** Administrative science bonus

## Effect description

Administrative science bonus. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Administrative science bonus"
