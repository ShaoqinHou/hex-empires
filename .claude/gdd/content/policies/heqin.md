...
Marriage-alliance diplomacy.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** exploration
- **Unlock:** Diplomatic Service civic
- **Effect:** +50% Influence toward Endeavors

## Effect description

+50% Influence toward Endeavors. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+50% Influence toward Endeavors"
