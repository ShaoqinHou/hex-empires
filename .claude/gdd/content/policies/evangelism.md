...
- **Age:** exploration
- **Unlock:** Theology civic
- **Effect:** +1 Faith per turn per follower settlement

## Effect description

+1 Faith per turn per follower settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Faith per turn per follower settlement"
