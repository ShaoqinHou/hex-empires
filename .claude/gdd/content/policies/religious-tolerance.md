# Religious Tolerance - Civ VII

**Slug:** `religious-tolerance`
**Category:** `policy`
**Age:** `exploration`
**Status:** `draft`
**Confidence:** `medium`
...
Tolerance as statecraft.

## Stats / numeric attributes

- **Category:** `crisis` (standard / crisis / tradition)
- **Age:** exploration
- **Unlock:** Wars of Religion
- **Effect:** Benefits players with multiple religions [INFERRED effect]

## Effect description

Benefits players with multiple religions [INFERRED effect]. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "Benefits players with multiple religions [INFERRED effect]"
