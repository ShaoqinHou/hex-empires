...
- **Age:** exploration
- **Unlock:** Bureaucracy civic
- **Effect:** +1 Policy Slot

## Effect description

+1 Policy Slot. Slottable into any wildcard policy slot (VII has no type restrictions).
