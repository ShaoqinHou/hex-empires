...
Basic craft productivity.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Chiefdom civic
- **Effect:** +1 Production on Workshops and early craft buildings

## Effect description

+1 Production on Workshops and early craft buildings. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Production on Workshops and early craft buildings"
