...
Trung Tac Leader Path memento. Banner of resistance.

## Stats / numeric attributes

- **Path:** Leader — Trung Tac
- **Unlock level:** Leader Path L5
- **Effect:** Rebellion suppression bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Rebellion suppression bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    leader: trung-tac
    level: 5
    description: "Rebellion suppression bonus"
```
