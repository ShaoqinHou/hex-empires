# Qibla Compass - Civ VII

**Slug:** `ibn-battuta-compass`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
Ibn Battuta Leader Path memento. Mecca-direction compass.

## Stats / numeric attributes

- **Path:** Leader — Ibn Battuta
- **Unlock level:** Leader Path L5
- **Effect:** Trade Route range bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Trade Route range bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    leader: ibn-battuta
    level: 5
    description: "Trade Route range bonus"
```
