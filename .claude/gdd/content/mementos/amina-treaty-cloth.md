# Treaty Cloth - Civ VII

**Slug:** `amina-treaty-cloth`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
Amina Leader Path memento. Hausa textile diplomacy.

## Stats / numeric attributes

- **Path:** Leader — Amina
- **Unlock level:** Leader Path L5
- **Effect:** Influence on trade agreements
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Influence on trade agreements `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    leader: amina
    level: 5
    description: "Influence on trade agreements"
```
