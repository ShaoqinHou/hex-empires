# Tricolor Banner - Civ VII

**Slug:** `napoleon-revo-tricolor`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.claude/gdd/content/leaders/napoleon-revolutionary.md` (parent leader fact card)
- `.claude/gdd/systems/mementos.md` + `.claude/gdd/systems/legends.md`

## Identity

Napoleon Revolutionary Leader Path memento. Revolutionary flag.

## Stats / numeric attributes

- **Path:** Leader — Napoleon Revolutionary
- **Unlock level:** Leader Path L5
- **Effect:** Revolutionary civic bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Revolutionary civic bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 5
    description: "Revolutionary civic bonus"
```
