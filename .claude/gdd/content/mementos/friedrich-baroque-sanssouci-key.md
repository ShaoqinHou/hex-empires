# Sanssouci Key - Civ VII

**Slug:** `friedrich-baroque-sanssouci-key`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
Friedrich Baroque Leader Path memento. Rococo palace of Frederick the Great.

## Stats / numeric attributes

- **Path:** Leader — Friedrich Baroque
- **Unlock level:** Leader Path L2
- **Effect:** +1 Culture per Wonder
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. +1 Culture per Wonder `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 2
    description: "+1 Culture per Wonder"
```
