...
- `.claude/gdd/content/leaders/harriet-tubman.md` (parent leader fact card)
- `.claude/gdd/systems/mementos.md` + `.claude/gdd/systems/legends.md`

## Identity

Harriet Tubman Leader Path memento. Underground Railroad signal lantern.

## Stats / numeric attributes

- **Path:** Leader — Harriet Tubman
- **Unlock level:** Leader Path L2
- **Effect:** Free Migrant in Capital per undetected Espionage action
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Free Migrant in Capital per undetected Espionage action `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 2
    description: "Free Migrant in Capital per undetected Espionage action"
```
