# Pipe of the Prophet - Civ VII

**Slug:** `tecumseh-vision-pipe`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.claude/gdd/content/leaders/tecumseh.md` (parent leader fact card)
- `.claude/gdd/systems/mementos.md` + `.claude/gdd/systems/legends.md`

## Identity

Tecumseh Leader Path memento. Tenskwatawa's prophetic vision.
