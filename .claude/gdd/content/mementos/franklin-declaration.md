# Declaration Draft - Civ VII

**Slug:** `franklin-declaration`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
Benjamin Franklin Leader Path memento. Founding document revisions.

## Stats / numeric attributes

- **Path:** Leader — Benjamin Franklin
- **Unlock level:** Leader Path L9
- **Effect:** Policy slot bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Policy slot bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
