# Winter Palace Key - Civ VII

**Slug:** `catherine-winter-palace-key`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.claude/gdd/content/leaders/catherine-the-great.md` (parent leader fact card)
- `.claude/gdd/systems/mementos.md` + `.claude/gdd/systems/legends.md`

## Identity

Catherine The Great Leader Path memento. Hermitage / Winter Palace symbolic key.
...
Pre-game equippable item. Effect persists the whole game. Wonder bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
