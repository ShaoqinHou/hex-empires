...
Benjamin Franklin Leader Path memento. Experimental demonstration of electricity.

## Stats / numeric attributes

- **Path:** Leader — Benjamin Franklin
- **Unlock level:** Leader Path L5
- **Effect:** +20% Science per Specialist
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. +20% Science per Specialist `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 5
    description: "+20% Science per Specialist"
```
