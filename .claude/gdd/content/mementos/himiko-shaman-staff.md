# Shaman Staff - Civ VII

**Slug:** `himiko-shaman-staff`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
Himiko High Shaman Leader Path memento. Shinto ritual implement.
...
Pre-game equippable item. Effect persists the whole game. Faith bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
