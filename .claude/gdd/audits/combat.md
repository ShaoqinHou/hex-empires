...
Paste into .claude/gdd/systems/combat.md section Mapping to hex-empires:

Status: 4 MATCH / 2 CLOSE / 4 DIVERGED / 3 MISSING / 1 EXTRA (audit: .claude/gdd/audits/combat.md)
