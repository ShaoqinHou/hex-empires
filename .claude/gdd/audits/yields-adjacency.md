...
Paste into `.claude/gdd/systems/yields-adjacency.md` § "Mapping to hex-empires":
...
**Status:** 1 MATCH / 2 CLOSE / 2 DIVERGED / 4 MISSING / 1 EXTRA (see `.claude/gdd/audits/yields-adjacency.md`)
