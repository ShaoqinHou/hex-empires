...
Paste into `.claude/gdd/systems/settlements.md` § "Mapping to hex-empires":
...
**Status:** 3 MATCH / 3 CLOSE / 0 DIVERGED / 4 MISSING / 1 EXTRA (see `.claude/gdd/audits/settlements.md`)
