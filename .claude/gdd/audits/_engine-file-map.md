...
1. Its row's GDD system doc: `.claude/gdd/systems/<slug>.md`
...
- Content fact cards under `.claude/gdd/content/<cat>/<slug>.md` (except `_overview.md` when mechanic references counts) — fact cards are VII data, not engine logic
