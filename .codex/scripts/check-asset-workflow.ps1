...
Require-Text $assetDoc "Status: paused" "paused asset workflow status"
...
Require-Text $assetDoc "Camera Settings" "camera settings"
Require-Text $assetDoc "Camera elevation" "camera elevation rule"
Require-Text $assetDoc "45 degrees above the ground plane" "camera elevation value"
Require-Text $assetDoc "Direction Standard" "direction standard"
Require-Text $assetDoc "fixed orthographic camera" "fixed camera rule"
Require-Text $assetDoc "rotate the subject" "subject turntable rule"
Require-Text $assetDoc "S/front" "front direction definition"
Require-Text $assetDoc "W/profile-left" "profile direction definition"
Require-Text $assetDoc "N/back" "back direction definition"
Require-Text $assetDoc "Generation Strategy" "generation strategy"
Require-Text $assetDoc "direction-by-direction-reference" "direction-by-direction generation mode"
Require-Text $assetDoc "Mirroring policy" "mirroring policy"
Require-Text $assetDoc "right-hand weapon" "handedness mirroring rule"
Require-Text $assetDoc "5-source-plus-code-mirror" "code mirror generation mode"
Require-Text $assetDoc "unit-turntable-v1" "unit direction standard id"
...
Require-Text $assetSkill "Status: paused" "paused asset skill status"
