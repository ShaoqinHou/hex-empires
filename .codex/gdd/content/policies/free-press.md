...
- **Age:** modern
- **Unlock:** Liberalism civic
- **Effect:** +2 Culture per Newspaper [building]

## Effect description

+2 Culture per Newspaper [building]. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Culture per Newspaper [building]"
