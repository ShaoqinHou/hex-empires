...
- **Age:** antiquity
- **Unlock:** Tactics civic
- **Effect:** +25% XP gain for Commanders during exercises

## Effect description

+25% XP gain for Commanders during exercises. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+25% XP gain for Commanders during exercises"
