...
- **Age:** modern
- **Unlock:** Capitalism Mastery
- **Effect:** +30% Gold from Factory resources

## Effect description

+30% Gold from Factory resources. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+30% Gold from Factory resources"
