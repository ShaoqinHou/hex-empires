...
- **Age:** modern
- **Unlock:** Militarism Mastery
- **Effect:** +5 CS defending in districts

## Effect description

+5 CS defending in districts. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+5 CS defending in districts"
