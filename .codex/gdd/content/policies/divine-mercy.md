...
- **Effect:** Religion-follower Districts/Buildings immune to Minor Outbreaks

## Effect description

Religion-follower Districts/Buildings immune to Minor Outbreaks. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "Religion-follower Districts/Buildings immune to Minor Outbreaks"
