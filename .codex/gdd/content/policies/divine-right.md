...
Royal sovereignty sacralized.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** exploration
- **Unlock:** Sovereignty Mastery
- **Effect:** +5 Happiness in Capital

## Effect description

+5 Happiness in Capital. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+5 Happiness in Capital"
