...
- **Age:** antiquity
- **Unlock:** Mysticism civic
- **Effect:** +1 Faith per Altar

## Effect description

+1 Faith per Altar. Slottable into any wildcard policy slot (VII has no type restrictions).
