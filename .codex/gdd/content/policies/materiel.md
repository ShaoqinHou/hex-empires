...
Industrial war supply.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** modern
- **Unlock:** Militarism civic
- **Effect:** +15% Production toward military units

## Effect description

+15% Production toward military units. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+15% Production toward military units"
