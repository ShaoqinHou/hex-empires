...
- **Age:** modern
- **Unlock:** Progressivism civic
- **Effect:** +3 Culture per Opera House

## Effect description

+3 Culture per Opera House. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+3 Culture per Opera House"
