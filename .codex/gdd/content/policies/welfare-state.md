...
- **Age:** modern
- **Unlock:** Liberalism Mastery
- **Effect:** +2 Amenities per Settlement

## Effect description

+2 Amenities per Settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Amenities per Settlement"
