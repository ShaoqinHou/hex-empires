...
Minted currency economy.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Skilled Trades civic
- **Effect:** +2 Gold per Market; +1 Trade Route

## Effect description

+2 Gold per Market; +1 Trade Route. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Gold per Market; +1 Trade Route"
