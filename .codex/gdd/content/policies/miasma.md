...
- **Effect:** -25% City Growth; +1 Migrant per Infection

## Effect description

-25% City Growth; +1 Migrant per Infection. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "-25% City Growth; +1 Migrant per Infection"
