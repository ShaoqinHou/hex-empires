# Recruitment Shortfalls - Civ VII

**Slug:** `recruitment-shortfalls`
**Category:** `policy`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** -15 Healing on Units; +2 Food in Towns

## Effect description

-15 Healing on Units; +2 Food in Towns. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "-15 Healing on Units; +2 Food in Towns"
