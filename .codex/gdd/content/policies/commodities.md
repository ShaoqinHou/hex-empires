...
- **Age:** antiquity
- **Unlock:** Commerce civic
- **Effect:** +1 Gold per assigned Resource

## Effect description

+1 Gold per assigned Resource. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Gold per assigned Resource"
