# Projection of Force - Civ VII

**Slug:** `projection-of-force`
**Category:** `policy`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** modern
- **Unlock:** Militarism (late)
- **Effect:** +1 Movement for Naval units; carrier bonus

## Effect description

+1 Movement for Naval units; carrier bonus. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Movement for Naval units; carrier bonus"
