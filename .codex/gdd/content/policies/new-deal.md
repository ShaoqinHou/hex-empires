...
- **Age:** modern
- **Unlock:** Progressivism
- **Effect:** +10% Production on Infrastructure during Depression

## Effect description

+10% Production on Infrastructure during Depression. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+10% Production on Infrastructure during Depression"
