...
- **Age:** antiquity
- **Unlock:** Commerce
- **Effect:** +1 Healing for Units in friendly territory; +1 Happiness per Hospital [INFERRED]

## Effect description

+1 Healing for Units in friendly territory; +1 Happiness per Hospital [INFERRED]. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Healing for Units in friendly territory; +1 Happiness per Hospital [INFERRED]"
