...
- **Age:** modern
- **Unlock:** Political Theory civic
- **Effect:** +2 Culture per turn; press freedom

## Effect description

+2 Culture per turn; press freedom. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Culture per turn; press freedom"
