...
- **Age:** antiquity/ageless
- **Unlock:** Greece civ
- **Effect:** Commander and Hoplite bonus

## Effect description

Commander and Hoplite bonus. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Commander and Hoplite bonus"
