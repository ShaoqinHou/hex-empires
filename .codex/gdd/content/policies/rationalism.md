...
- **Age:** exploration
- **Unlock:** Inspiration civic
- **Effect:** +2 Science in Cities with 3+ Specialists

## Effect description

+2 Science in Cities with 3+ Specialists. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Science in Cities with 3+ Specialists"
