...
- **Effect:** +1 Amenity per Settlement

## Effect description

+1 Amenity per Settlement. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Amenity per Settlement"
