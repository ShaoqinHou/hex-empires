...
Written knowledge flourishes.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Literacy civic
- **Effect:** +2 Science per Library

## Effect description

+2 Science per Library. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Science per Library"
