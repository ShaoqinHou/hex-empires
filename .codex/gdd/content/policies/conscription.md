...
- **Age:** antiquity
- **Unlock:** Organized Military
- **Effect:** Reduced military unit maintenance -1 Gold

## Effect description

Reduced military unit maintenance -1 Gold. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "Reduced military unit maintenance -1 Gold"
