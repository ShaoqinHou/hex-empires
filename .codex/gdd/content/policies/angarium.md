...
- **Age:** antiquity/ageless
- **Unlock:** Persia civ
- **Effect:** Royal road maintenance

## Effect description

Royal road maintenance. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Royal road maintenance"
