...
Regulation of sea commerce.

## Stats / numeric attributes

- **Category:** `standard` (standard / crisis / tradition)
- **Age:** exploration
- **Unlock:** Economics civic
- **Effect:** +2 Gold per Sea Trade Route

## Effect description

+2 Gold per Sea Trade Route. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Gold per Sea Trade Route"
