...
- **Age:** modern
- **Unlock:** Social Question
- **Effect:** +2 Culture per Social Policy Slot filled

## Effect description

+2 Culture per Social Policy Slot filled. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+2 Culture per Social Policy Slot filled"
