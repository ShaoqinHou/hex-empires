# Their Finest Hour - Civ VII

**Slug:** `their-finest-hour`
**Category:** `policy`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
- **Age:** modern
- **Unlock:** Progressivism Mastery
- **Effect:** +5 War Support in defensive wars

## Effect description

+5 War Support in defensive wars. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+5 War Support in defensive wars"
