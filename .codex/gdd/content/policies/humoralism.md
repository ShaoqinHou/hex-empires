...
- **Effect:** Science when Physician treats on Hospital tile

## Effect description

Science when Physician treats on Hospital tile. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "Science when Physician treats on Hospital tile"
