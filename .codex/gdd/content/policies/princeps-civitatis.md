# Princeps Civitatis - Civ VII

**Slug:** `princeps-civitatis`
**Category:** `policy`
...
- **Age:** antiquity/ageless
- **Unlock:** Rome civ
- **Effect:** First-citizen status; Wonder production bonus

## Effect description

First-citizen status; Wonder production bonus. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "First-citizen status; Wonder production bonus"
