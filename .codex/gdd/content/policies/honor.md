...
- **Age:** antiquity
- **Unlock:** Discipline Mastery
- **Effect:** +1 Combat Strength to Infantry units

## Effect description

+1 Combat Strength to Infantry units. Slottable into any wildcard policy slot (VII has no type restrictions).
...
effects:
  - type: POLICY_EFFECT
    category: standard
    description: "+1 Combat Strength to Infantry units"
