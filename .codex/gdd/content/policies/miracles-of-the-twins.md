# Miracles of the Twins - Civ VII

**Slug:** `miracles-of-the-twins`
**Category:** `policy`
...
- **Age:** antiquity/ageless
- **Unlock:** Maya civ
- **Effect:** Religious yield bonus

## Effect description

Religious yield bonus. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Religious yield bonus"
