...
Barbarian tribute payment.

## Stats / numeric attributes

- **Category:** `crisis` (standard / crisis / tradition)
- **Age:** antiquity
- **Unlock:** Invasion Stage 1
- **Effect:** -10 Gold per City-State Suzerainty

## Effect description

-10 Gold per City-State Suzerainty. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "-10 Gold per City-State Suzerainty"
