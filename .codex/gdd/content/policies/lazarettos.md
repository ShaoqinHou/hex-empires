...
- **Effect:** Coastal Settlements with Dungeon: no Major Outbreak building damage

## Effect description

Coastal Settlements with Dungeon: no Major Outbreak building damage. This is a **crisis-only** policy unlocked during specific end-of-age crisis stages; see `content/crisis-cards/`.
...
effects:
  - type: POLICY_EFFECT
    category: crisis
    description: "Coastal Settlements with Dungeon: no Major Outbreak building damage"
