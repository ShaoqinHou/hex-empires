# Shell-Tempered Pottery - Civ VII

**Slug:** `shell-tempered-pottery`
**Category:** `policy`
...
Mississippian craft tradition.

## Stats / numeric attributes

- **Category:** `tradition` (standard / crisis / tradition)
- **Age:** antiquity/ageless
- **Unlock:** Mississippian civ
- **Effect:** Ceramic bonus yield

## Effect description

Ceramic bonus yield. This is a **tradition** earned from a civ-unique civic in a past age; it remains selectable in all future ages.
...
effects:
  - type: POLICY_EFFECT
    category: tradition
    description: "Ceramic bonus yield"
