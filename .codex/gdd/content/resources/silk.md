...
Silk Road trade good; Chinese royal monopoly for centuries.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** tropical/grassland
- **Yield / Effect:** Ant: +10% Culture; Expl: +10% Culture; Mod: +6 Culture Capital
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "Ant: +10% Culture; Expl: +10% Culture; Mod: +6 Culture Capital"
```
