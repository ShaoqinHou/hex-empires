...
Plantation crop; sugar drove the Atlantic slave trade.
...
- **Yield / Effect:** Expl: Creates Treasure Fleets (coastal); Mod: +6 Food
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Expl: Creates Treasure Fleets (coastal); Mod: +6 Food"
