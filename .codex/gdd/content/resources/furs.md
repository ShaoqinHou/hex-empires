...
Russian and North American fur trade; beaver, sable, ermine.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Exploration + Modern
- **Terrain spawn:** tundra/forest
- **Yield / Effect:** Expl: +3 Hap Capital; Mod: +6 Hap City with Rail
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "Expl: +3 Hap Capital; Mod: +6 Hap City with Rail"
```
