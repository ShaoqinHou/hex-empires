...
Murex purple, indigo, and other trade dyes.

## Stats / numeric attributes

- **Type:** `bonus` resource
- **Age(s) available:** Antiquity + Exploration
- **Terrain spawn:** jungle/marsh
- **Yield / Effect:** Ant: +3 Happiness; Expl: +5 Happiness
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Ant: +3 Happiness; Expl: +5 Happiness"
```
