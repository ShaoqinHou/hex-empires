...
Cotton textile production; Indian, Mesoamerican, and later industrial trade good.

## Stats / numeric attributes

- **Type:** `bonus` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** plains/desert
- **Yield / Effect:** Ant: +2F+2P; Expl: +3F+3P; Mod: +5% Prod to Land Units (Factory)
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: bonus
    effect: "Ant: +2F+2P; Expl: +3F+3P; Mod: +5% Prod to Land Units (Factory)"
```
