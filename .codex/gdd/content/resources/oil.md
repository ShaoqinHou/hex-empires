...
Petroleum; Modern era strategic resource.

## Stats / numeric attributes

- **Type:** `empire` resource
- **Age(s) available:** Modern
- **Terrain spawn:** coastal/desert
- **Yield / Effect:** +1 CS Heavy Naval+Cavalry, +1 vs Infantry
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "+1 CS Heavy Naval+Cavalry, +1 vs Infantry"
```
