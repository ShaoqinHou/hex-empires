...
Steppe horse domestication revolutionized warfare.

## Stats / numeric attributes

- **Type:** `empire` resource
- **Age(s) available:** Antiquity + Exploration + Modern
- **Terrain spawn:** plains/grassland
- **Yield / Effect:** Ant: +1 CS Cavalry; Expl: +1 CS Cavalry; Mod: +6 Happiness
...
effects:
  - type: RESOURCE_ASSIGNMENT
    ...
    effect: "Ant: +1 CS Cavalry; Expl: +1 CS Cavalry; Mod: +6 Happiness"
```
