...
Preservative and trade staple; Saharan trans-desert trade.

## Stats / numeric attributes

- **Type:** `city` resource
- **Age(s) available:** Antiquity
- **Terrain spawn:** desert/plains
- **Yield / Effect:** +20% Production to training Units
...
effects:
  - type: RESOURCE_ASSIGNMENT
    resource_type: city
    effect: "+20% Production to training Units"
```
