...
- **Effect:** +1 to all yields on Altar buildings
...
Altars are Antiquity-era religious buildings. Each Altar gets +1 Food, Production, Gold, Science, Culture, and Faith. Compound value scales with Altar count.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 to all yields on Altar buildings"
    scope: empire
