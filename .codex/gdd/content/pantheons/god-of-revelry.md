...
- **Effect:** +1 Happiness on Resources
...
**Non-unique** — multiple players. +1 Happiness for each slotted resource in the empire. Scales with resource assignment capacity (tech/civic unlocks).
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Happiness on Resources"
    scope: empire
