# Goddess of Festivals — Civ VII

**Slug:** `goddess-of-festivals`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
Culture equivalent of God of Wisdom. Feeds Civics tree progress. Requires active Quarter formation.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Culture on Quarters"
    scope: empire
