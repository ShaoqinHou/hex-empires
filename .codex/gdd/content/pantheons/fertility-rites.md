# Fertility Rites — Civ VII

**Slug:** `fertility-rites`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +10% Growth Rate (all settlements)
...
Reduces the food-to-population threshold (effective threshold * 0.9). Stacks with leader/civic growth bonuses. Powerful for wide empires.
...
effects:
  - type: PANTHEON_BONUS
    description: "+10% Growth Rate (all settlements)"
    scope: empire
