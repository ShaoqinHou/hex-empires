...
- **Effect:** +1 Happiness for tiles adjacent to Coasts / Lakes / Rivers
...
Happiness pantheon with wider applicability than Earth Goddess (water adjacency is more common than mountain adjacency).
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Happiness for tiles adjacent to Coasts / Lakes / Rivers"
    scope: empire
