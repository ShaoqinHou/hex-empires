...
Every Quarter (two-building urban tile) gets +1 Science. Requires the player to actively form Quarters — civ-unique pair or standard same-age pair.
...
effects:
  - type: PANTHEON_BONUS
    description: "+1 Science on Quarters"
    scope: empire
