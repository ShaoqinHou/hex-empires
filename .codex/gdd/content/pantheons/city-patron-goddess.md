# City Patron Goddess — Civ VII

**Slug:** `city-patron-goddess`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +3 Influence on Altar buildings
...
Each Altar generates +3 Influence per turn. Early Influence pipeline for Diplomatic-leaning players; stacks across all settlements with Altars.
...
effects:
  - type: PANTHEON_BONUS
    description: "+3 Influence on Altar buildings"
    scope: empire
