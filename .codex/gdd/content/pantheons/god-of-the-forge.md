# God of the Forge — Civ VII

**Slug:** `god-of-the-forge`
**Category:** `pantheon`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
- **Effect:** +10% Production toward buildings
...
Faster city infrastructure. Synergizes well with Quarter-focused civs racing to assemble two unique buildings on a single urban tile.
...
effects:
  - type: PANTHEON_BONUS
    description: "+10% Production toward buildings"
    scope: empire
