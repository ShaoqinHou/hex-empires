...
- https://civilization.fandom.com/wiki/Category:Religion_icons_(Civ7) — Fandom icon category (403; confirmed via web search snippet that Buddhism icon is in vanilla set)

## Identity

- Historical period: Founded c. 5th–4th century BCE in the Indian subcontinent by Siddhartha Gautama; spread throughout Asia via trade and missionary routes during the Exploration-era equivalent timeframe.
- Flavor: Buddhism is one of the pre-defined historical religion options available as a cosmetic selection at religion founding. Its icon is included in the vanilla Civ VII religion icon set.
...
- Effect: Cosmetic only — no unique gameplay effect tied to the name "Buddhism." All effects come from chosen beliefs.
...
### Available Beliefs (shared pool — not Buddhism-specific)
...
The religion name "Buddhism" in Civ VII carries no unique gameplay effect; it is a cosmetic label chosen at founding alongside an icon. The belief pool (Reliquary, Founder, Enhancer) is the same shared set for all religions. Confirmed via Game8, TheGamer. The `Vipassana` founder belief has a thematic connection to Buddhist practice but can be chosen by any religion. [LLM-KNOWLEDGE-ONLY] for historical period details.
