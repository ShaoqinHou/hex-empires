...
- **Celebration effect options:** +30% Production; -15% Happiness
...
Modern-age industrial government. Extreme production bonus traded against empire happiness. Powerful for Ideology (Military Legacy) runs.
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+30% Production; -15% Happiness"
