# Bureaucratic Monarchy - Civ VII

**Slug:** `bureaucratic-monarchy`
**Category:** `government`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
- **Celebration effect options:** +2 Amenity per Settlement; +15% Gold
...
Modern-age administrative government. Economic and happiness bonuses; broad applicability.
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+2 Amenity per Settlement; +15% Gold"
