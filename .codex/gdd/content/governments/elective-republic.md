# Elective Republic - Civ VII

**Slug:** `elective-republic`
**Category:** `government`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
One of the Civ VII governments in the **Modern** age. Standard government - available to all civs once the relevant age is reached.

## Stats / numeric attributes

- **Age:** modern
- **Policy slots granted on adoption:** +1 (all governments grant this baseline)
- **Celebration effect options:** +1 Policy Slot; +15% Science; +15% Culture
- **Unlock:** Reach Modern age (selected at age transition)
- **Switch cost:** One government per age, permanently locked for that age (no mid-age switching, no anarchy penalty)

## Effect description

Modern-age democratic government. Science + Culture boost; good for Cultural/Scientific Legacy Path Modern endgame.
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+1 Policy Slot; +15% Science; +15% Culture"
