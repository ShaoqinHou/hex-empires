# Revolutionary Authoritarianism - Civ VII

**Slug:** `revolutionary-authoritarianism`
**Category:** `government`
**Age:** `exploration`
**Status:** `draft`
**Confidence:** `medium`
...
- **Celebration effect options:** +30% Military Production; -10% Gold
...
**Crisis-locked.** Unlocked via the Revolutions crisis with authoritarian choices. Trades economic output for military surge.
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+30% Military Production; -10% Gold"
