# Constitutional Monarchy - Civ VII
...
- **Celebration effect options:** +2 Happiness; +1 Policy Slot
...
**Crisis-locked.** Middle-path Revolutions crisis outcome. Stability-focused with a happiness buffer.
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+2 Happiness; +1 Policy Slot"
