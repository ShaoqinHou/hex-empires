...
- **Celebration effect options:** +50% Faith; +2 Culture per Religious Building
...
Exploration-age faith-focused government. Strongly synergizes with Religion founding and Cultural Legacy Path (Toshakhana relics).
...
effects:
  ...
  - type: CELEBRATION_BONUS_OPTIONS
    options: "+50% Faith; +2 Culture per Religious Building"
