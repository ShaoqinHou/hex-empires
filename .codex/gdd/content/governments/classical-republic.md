# Classical Republic - Civ VII

**Slug:** `classical-republic`
**Category:** `government`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
One of the Civ VII governments in the **Antiquity** age. Standard government - available to all civs once the relevant age is reached.

## Stats / numeric attributes

- **Age:** antiquity
- **Policy slots granted on adoption:** +1 (all governments grant this baseline)
- **Celebration effect options:** +10% Science; +10% Culture
- **Unlock:** Reach Antiquity age (selected at age transition)
- **Switch cost:** One government per age, permanently locked for that age (no mid-age switching, no anarchy penalty)

## Effect description

One of three Antiquity governments. Balanced yields focused on tech and civics research. Grants +1 policy slot on adoption.
