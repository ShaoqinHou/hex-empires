# The Night of the Torches - Civ VII

**Slug:** `revolution-whispers`
...
Pre-Revolution crisis choice.

## Stats / numeric attributes

- **Trigger type:** crisis-approach
- **Trigger condition:** Revolutions crisis approaching
- **Age:** exploration
- **Options:** 2 choices

## Choice effects

- **A: Crack down on dissent:** -2 Happiness in all cities, +3 CS defending cities
- **B: Offer reforms:** +1 Social Policy slot, but more revolution policies required when crisis fires
...
triggers:
  - type: crisis-approach
    condition: "Revolutions crisis approaching"
