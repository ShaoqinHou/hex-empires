...
The first kill marks a civilization's entry into warfare.

## Stats / numeric attributes

- **Trigger type:** combat
- **Trigger condition:** First unit kill by player
- **Age:** antiquity
- **Options:** 2 choices

## Choice effects

- **A: Celebrate the victor:** +5 Happiness in Capital
- **B: Memorialize the fallen:** +1 Culture per fallen unit
...
triggers:
  - type: combat
    condition: "First unit kill by player"
