# Cradle on the Sea - Civ VII

**Slug:** `starting-on-coast`
...
Coastal founding shapes the civilization toward maritime trade and naval power.

## Stats / numeric attributes

- **Trigger type:** starting-tile
- **Trigger condition:** Capital founded on Coastal tile
- **Age:** antiquity
- **Options:** 2 choices

## Choice effects

- **A: Build a navy early:** Free Galley unit
- **B: Fishing economy:** +2 Food per Coastal Fish resource
...
triggers:
  - type: starting-tile
    condition: "Capital founded on Coastal tile"
