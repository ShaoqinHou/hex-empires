...
- Age: exploration
- Prerequisite: Shipbuilding + Education
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Menagerie, Pavilion
- Mastery reward: +1 Culture on Culture Buildings, 1 Relic
...
effects:
  - type: UNLOCK
    items: "Menagerie, Pavilion"
  - type: MASTERY_REWARD
    effect: "+1 Culture on Culture Buildings, 1 Relic"
```
