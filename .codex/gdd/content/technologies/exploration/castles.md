...
- Unlocks: Dungeon, Medieval Walls, Crossbowman
- Mastery reward: +3 CS Fortified Districts, Open the Gates
...
effects:
  - type: UNLOCK
    items: "Dungeon, Medieval Walls, Crossbowman"
  - type: MASTERY_REWARD
    effect: "+3 CS Fortified Districts, Open the Gates"
```
