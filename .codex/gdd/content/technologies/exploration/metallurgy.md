...
- Age: exploration
- Prerequisite: Castles + Heraldry
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Armorer, Trebuchet
- Mastery reward: +3 CS Range/Siege, +2 Prod Military Buildings
...
effects:
  - type: UNLOCK
    items: "Armorer, Trebuchet"
  - type: MASTERY_REWARD
    effect: "+3 CS Range/Siege, +2 Prod Military Buildings"
```
