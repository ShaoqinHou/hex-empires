...
- Age: exploration
- Prerequisite: Astronomy + Cartography
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Inn, +1 Settlement Limit, Medieval Bridge
- Mastery reward: +1 Food on Farms/Pastures/Plantations
...
effects:
  - type: UNLOCK
    items: "Inn, +1 Settlement Limit, Medieval Bridge"
  - type: MASTERY_REWARD
    effect: "+1 Food on Farms/Pastures/Plantations"
```
