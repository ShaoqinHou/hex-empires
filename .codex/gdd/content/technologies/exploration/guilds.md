...
- Unlocks: Guildhall, Kiln
- Mastery reward: +1 Gold on Gold Buildings, +1 Prod on Clay Pits/Mines
...
effects:
  - type: UNLOCK
    items: "Guildhall, Kiln"
  - type: MASTERY_REWARD
    effect: "+1 Gold on Gold Buildings, +1 Prod on Clay Pits/Mines"
```
