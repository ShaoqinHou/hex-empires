...
- Age: antiquity
- Prerequisite: Irrigation + Masonry
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Villa, Ballista, Chariot
- Mastery reward: Military Infiltration, 1 Codex, +1 Movement Siege
...
effects:
  - type: UNLOCK
    items: "Villa, Ballista, Chariot"
  - type: MASTERY_REWARD
    effect: "Military Infiltration, 1 Codex, +1 Movement Siege"
```
