...
- Unlocks: Ancient Walls, Monument, Pyramids
- Mastery reward: +1 Prod on Mines/Quarries, +3 CS fortified districts
...
effects:
  - type: UNLOCK
    items: "Ancient Walls, Monument, Pyramids"
  - type: MASTERY_REWARD
    effect: "+1 Prod on Mines/Quarries, +3 CS fortified districts"
```
