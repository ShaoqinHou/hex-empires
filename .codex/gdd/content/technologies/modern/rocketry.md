...
- Age: modern
- Prerequisite: Aerodynamics
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Launch Pad
- Mastery reward: Sabotage Space Program, Launch Satellite, Staffed Space Flight
...
effects:
  - type: UNLOCK
    items: "Launch Pad"
  - type: MASTERY_REWARD
    effect: "Sabotage Space Program, Launch Satellite, Staffed Space Flight"
```
