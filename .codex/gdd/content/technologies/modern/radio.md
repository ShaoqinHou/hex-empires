...
- Age: modern
- Prerequisite: Electricity + Urbanization
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Radio Station, Tenement, Eiffel Tower
- Mastery reward: +1 Culture on Culture Buildings, +1 Happiness on Happiness Buildings
...
effects:
  - type: UNLOCK
    items: "Radio Station, Tenement, Eiffel Tower"
  - type: MASTERY_REWARD
    effect: "+1 Culture on Culture Buildings, +1 Happiness on Happiness Buildings"
```
