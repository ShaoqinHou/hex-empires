...
- Age: modern
- Prerequisite: Military Science
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Rail Station, Field Gun, Howitzer, Rifle Infantry, Marine
- Mastery reward: +3 CS Infantry, +1 Prod on Mines/Woodcutters
...
effects:
  - type: UNLOCK
    items: "Rail Station, Field Gun, Howitzer, Rifle Infantry, Marine"
  - type: MASTERY_REWARD
    effect: "+3 CS Infantry, +1 Prod on Mines/Woodcutters"
```
