...
- Age: modern
- Prerequisite: Mobilization + Armor
- Cost (Science): `[INFERRED]` - exact per-tech costs not published by Firaxis
- Unlocks: Fighter, Dive Bomber, Heavy Bomber
- Mastery reward: Break the Sound Barrier, +3 CS Air Units
...
effects:
  - type: UNLOCK
    items: "Fighter, Dive Bomber, Heavy Bomber"
  - type: MASTERY_REWARD
    effect: "Break the Sound Barrier, +3 CS Air Units"
```
