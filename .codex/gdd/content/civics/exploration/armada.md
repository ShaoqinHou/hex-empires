...
**Civ-unique: spain.** A Exploration-Age civic in Civ VII's per-age civic tree. The grand fleet.
...
- Unlocks: Fleet Commanders get Flotilla
- Mastery reward: Land Units +2 Movement when Embarked
...
effects:
  - type: UNLOCK
    items: "Fleet Commanders get Flotilla"
  - type: MASTERY_REWARD
    effect: "Land Units +2 Movement when Embarked"
```
