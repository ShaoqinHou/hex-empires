...
A Exploration-Age civic in Civ VII's per-age civic tree. Global rule by conquest and commerce.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 2100
- Prerequisite: colonialism
- Unlocks: Indenture, Tariffs, +1 Settlement Limit
- Mastery reward: Commissioned Officers, Erdene Zuu, 1 Relic
...
effects:
  - type: UNLOCK
    items: "Indenture, Tariffs, +1 Settlement Limit"
  - type: MASTERY_REWARD
    effect: "Commissioned Officers, Erdene Zuu, 1 Relic"
```
