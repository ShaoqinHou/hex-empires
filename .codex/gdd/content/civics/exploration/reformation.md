...
A Exploration-Age civic in Civ VII's per-age civic tree. Doctrinal schism reshapes faith.
...
- Unlocks: Reformed religion mechanics [INFERRED]
...
effects:
  - type: UNLOCK
    items: "Reformed religion mechanics [INFERRED]"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
