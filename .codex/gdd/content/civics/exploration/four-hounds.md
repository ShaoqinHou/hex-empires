...
**Civ-unique: mongolia.** A Exploration-Age civic in Civ VII's per-age civic tree. Genghis's elite generals.
...
- Cost (Culture): 1200
- Prerequisite: ulus
- Unlocks: +1 Settlement Limit, free Noyan in Capital
- Mastery reward: +1 Settlement Limit, +1 Movement to Cavalry
...
effects:
  - type: UNLOCK
    items: "+1 Settlement Limit, free Noyan in Capital"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit, +1 Movement to Cavalry"
```
