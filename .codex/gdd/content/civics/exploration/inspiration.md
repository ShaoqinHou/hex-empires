...
A Exploration-Age civic in Civ VII's per-age civic tree. Artistic flowering reshapes cities.
...
- Unlocks: Renaissance policy, Hale o Keawe
...
effects:
  - type: UNLOCK
    items: "Renaissance policy, Hale o Keawe"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
