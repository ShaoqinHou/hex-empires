...
A Exploration-Age civic in Civ VII's per-age civic tree. Entry node; wealth as science of the state.
...
- Cost (Culture): 700
- Prerequisite: none
- Unlocks: Maritime Law policy, Merchant unit
...
effects:
  - type: UNLOCK
    items: "Maritime Law policy, Merchant unit"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
