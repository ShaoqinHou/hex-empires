...
**Civ-unique: majapahit.** A Exploration-Age civic in Civ VII's per-age civic tree. Shadow-puppet theatre.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: Candi Bentar building
- Mastery reward: +25% Production to Overbuilding
...
effects:
  - type: UNLOCK
    items: "Candi Bentar building"
  - type: MASTERY_REWARD
    effect: "+25% Production to Overbuilding"
```
