# New World Riches - Civ VII

**Slug:** `new-world-riches`
**Category:** `civic`
**Age:** `exploration`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: spain.** A Exploration-Age civic in Civ VII's per-age civic tree. Silver streams from Potosi.

## Stats / numeric attributes

- Age: exploration
- Cost (Culture): 1200
- Prerequisite: council-of-the-indies
- Unlocks: Cerro Rico improvement
- Mastery reward: +1 Settlement Limit, El Escorial wonder
...
effects:
  - type: UNLOCK
    items: "Cerro Rico improvement"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit, El Escorial wonder"
```
