...
**Civ-unique: shawnee.** A Exploration-Age civic in Civ VII's per-age civic tree. Sacred mound-building returns.
...
- Cost (Culture): 513
- Prerequisite: none
- Unlocks: Serpent Mound, Mawaskawe Skote
- Mastery reward: +1 Settlement Limit, Mawaskawe Skote +1 Culture per ally
- Civ-unique: YES (shawnee only)
...
effects:
  - type: UNLOCK
    items: "Serpent Mound, Mawaskawe Skote"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit, Mawaskawe Skote +1 Culture per ally"
```
