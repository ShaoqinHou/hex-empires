...
A Exploration-Age civic in Civ VII's per-age civic tree. Written rules for administrators.
...
- Unlocks: Constitution policy, Borobudur, +1 Policy Slot
...
effects:
  - type: UNLOCK
    items: "Constitution policy, Borobudur, +1 Policy Slot"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
