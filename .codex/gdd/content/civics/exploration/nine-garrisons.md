...
**Civ-unique: ming.** A Exploration-Age civic in Civ VII's per-age civic tree. Northern frontier fortified.
...
- Cost (Culture): 800
- Prerequisite: none
- Unlocks: Ming Great Wall improvement
- Mastery reward: Ming Great Wall +2 Gold with Bank
...
effects:
  - type: UNLOCK
    items: "Ming Great Wall improvement"
  - type: MASTERY_REWARD
    effect: "Ming Great Wall +2 Gold with Bank"
```
