# Organized Military - Civ VII

**Slug:** `organized-military`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
A Antiquity-Age civic in Civ VII's per-age civic tree. Standing army with logistics.
...
- Unlocks: Conscription policy, Mausoleum of Theodoric, +1 Settlement Limit
...
effects:
  - type: UNLOCK
    items: "Conscription policy, Mausoleum of Theodoric, +1 Settlement Limit"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
