...
**Civ-unique: maurya.** A Antiquity-Age civic in Civ VII's per-age civic tree. Royal council of ministers.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 400
- Prerequisite: acharya
- Unlocks: Increased yields in non-founded settlements, +1 Settlement Limit, Sanchi Stupa
- Mastery reward: `[none listed]`
- Civ-unique: YES (maurya only)
...
effects:
  - type: UNLOCK
    items: "Increased yields in non-founded settlements, +1 Settlement Limit, Sanchi Stupa"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
