# Exercitus Romanus - Civ VII

**Slug:** `exercitus-romanus`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: rome.** A Antiquity-Age civic in Civ VII's per-age civic tree. The professional Roman army.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Temple of Jupiter, Auxilia tradition
- Mastery reward: Legatus gains Bulwark promotion
- Civ-unique: YES (rome only)
...
effects:
  - type: UNLOCK
    items: "Temple of Jupiter, Auxilia tradition"
  - type: MASTERY_REWARD
    effect: "Legatus gains Bulwark promotion"
```
