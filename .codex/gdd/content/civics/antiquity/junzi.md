...
**Civ-unique: han.** A Antiquity-Age civic in Civ VII's per-age civic tree. The Confucian superior person.
...
- Cost (Culture): 400
- Prerequisite: li, yi
- Unlocks: +10% Science in Capital, Tianxia tradition, Weiyang Palace
...
effects:
  - type: UNLOCK
    items: "+10% Science in Capital, Tianxia tradition, Weiyang Palace"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
