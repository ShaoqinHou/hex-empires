...
**Civ-unique: khmer.** A Antiquity-Age civic in Civ VII's per-age civic tree. Royal authority via temple-cities.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 250
- Prerequisite: mousong
- Unlocks: Yuthahathi +1 Movement, Varna tradition, Angkor Wat
...
effects:
  - type: UNLOCK
    items: "Yuthahathi +1 Movement, Varna tradition, Angkor Wat"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
