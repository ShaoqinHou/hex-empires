...
**Civ-unique: mississippian.** A Antiquity-Age civic in Civ VII's per-age civic tree. Monumental mounds reshape landscape.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Potkop, +10% Production for buildings
- Mastery reward: +1 Settlement Limit, Monks Mound
- Civ-unique: YES (mississippian only)
...
effects:
  - type: UNLOCK
    items: "Potkop, +10% Production for buildings"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit, Monks Mound"
```
