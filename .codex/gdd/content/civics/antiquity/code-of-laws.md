...
A Antiquity-Age civic in Civ VII's per-age civic tree. Written law regularizes trade and judgment.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 245
- Prerequisite: public-life
- Unlocks: Oratory policy, Petra wonder, Merchant unit
- Mastery reward: Steal Government Secrets, Emile Bell policy
...
effects:
  - type: UNLOCK
    items: "Oratory policy, Petra wonder, Merchant unit"
  - type: MASTERY_REWARD
    effect: "Steal Government Secrets, Emile Bell policy"
```
