# Light of Amun-Ra - Civ VII

**Slug:** `light-of-amun-ra`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: egypt.** A Antiquity-Age civic in Civ VII's per-age civic tree. Solar theology legitimizes pharaonic rule.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 250
- Prerequisite: arrival-of-hapi
- Unlocks: +5 Gold on Palace, +1 Settlement Limit, Pyramids
...
effects:
  - type: UNLOCK
    items: "+5 Gold on Palace, +1 Settlement Limit, Pyramids"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
