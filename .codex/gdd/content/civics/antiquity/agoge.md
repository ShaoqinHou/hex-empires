...
**Civ-unique: greece.** A Antiquity-Age civic in Civ VII's per-age civic tree. State-mandated martial education.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Parthenon, Strategoi tradition
- Mastery reward: Hoplites +1 Combat per City-State
...
effects:
  - type: UNLOCK
    items: "Parthenon, Strategoi tradition"
  - type: MASTERY_REWARD
    effect: "Hoplites +1 Combat per City-State"
```
