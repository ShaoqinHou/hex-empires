...
**Civ-unique: persia.** A Antiquity-Age civic in Civ VII's per-age civic tree. Provincial governors under royal eye.
...
- Cost (Culture): 250
- Prerequisite: spada
- Unlocks: Pairidaeza, Angarium tradition, Gate of All Nations
- Mastery reward: +1 Settlement Limit
- Civ-unique: YES (persia only)
...
effects:
  - type: UNLOCK
    items: "Pairidaeza, Angarium tradition, Gate of All Nations"
  - type: MASTERY_REWARD
    effect: "+1 Settlement Limit"
```
