...
**Civ-unique: han.** A Antiquity-Age civic in Civ VII's per-age civic tree. Knowledge as statecraft.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Han Great Wall, Science building adjacency, +1 Settlement Limit
...
effects:
  - type: UNLOCK
    items: "Han Great Wall, Science building adjacency, +1 Settlement Limit"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
