...
**Civ-unique: han.** A Antiquity-Age civic in Civ VII's per-age civic tree. Ritual propriety binds the body politic.
...
- Cost (Culture): 250
- Prerequisite: zhi
- Unlocks: +2 Influence on Palace, Guanxi tradition
...
effects:
  - type: UNLOCK
    items: "+2 Influence on Palace, Guanxi tradition"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
