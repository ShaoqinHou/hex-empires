...
**Civ-unique: maya.** A Antiquity-Age civic in Civ VII's per-age civic tree. The storm god answers.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: K'uh Nah; Altars gain Science from vegetated tiles; Pet Kot tradition
...
effects:
  - type: UNLOCK
    items: "K'uh Nah; Altars gain Science from vegetated tiles; Pet Kot tradition"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
