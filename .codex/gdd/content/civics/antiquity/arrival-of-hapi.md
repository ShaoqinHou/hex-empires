# Arrival of Hapi - Civ VII

**Slug:** `arrival-of-hapi`
**Category:** `civic`
**Age:** `antiquity`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: egypt.** A Antiquity-Age civic in Civ VII's per-age civic tree. Annual Nile flood as divine gift.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Mortuary Temple; minor rivers dont end movement
...
effects:
  - type: UNLOCK
    items: "Mortuary Temple; minor rivers dont end movement"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
