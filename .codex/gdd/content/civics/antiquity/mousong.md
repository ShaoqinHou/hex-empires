...
**Civ-unique: khmer.** A Antiquity-Age civic in Civ VII's per-age civic tree. Hydraulic reservoirs stabilize the harvest.
...
- Cost (Culture): 150
- Prerequisite: none
- Unlocks: Baray; flood protection; Pithi Chrat tradition
...
effects:
  - type: UNLOCK
    items: "Baray; flood protection; Pithi Chrat tradition"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
