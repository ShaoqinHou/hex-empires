...
A Antiquity-Age civic in Civ VII's per-age civic tree. Long-distance trade formalizes.

## Stats / numeric attributes

- Age: antiquity
- Cost (Culture): 750
- Prerequisite: skilled-trades
- Unlocks: Commodities policy, Medicine, Monks Mound
...
effects:
  - type: UNLOCK
    items: "Commodities policy, Medicine, Monks Mound"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
