...
A Antiquity-Age civic in Civ VII's per-age civic tree. Artisan guilds and minted currency.
...
- Unlocks: Coinage policy, Colossus wonder
...
effects:
  - type: UNLOCK
    items: "Coinage policy, Colossus wonder"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
