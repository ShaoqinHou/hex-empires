...
**Civ-unique: french-empire.** A Modern-Age civic in Civ VII's per-age civic tree. Napoleonic corps system.

## Stats / numeric attributes

- Age: modern
- Cost (Culture): 3000
- Prerequisite: belle-epoque
- Unlocks: Commanders immediately gain a Promotion
- Mastery reward: Bataillon-Carre, +2 Combat per adjacent military
...
effects:
  - type: UNLOCK
    items: "Commanders immediately gain a Promotion"
  - type: MASTERY_REWARD
    effect: "Bataillon-Carre, +2 Combat per adjacent military"
```
