...
A Modern-Age civic in Civ VII's per-age civic tree. One nation, one people.

## Stats / numeric attributes

- Age: modern
- Cost (Culture): 3000
- Prerequisite: social-question
- Unlocks: Demagogy, +1 Settlement Limit
- Mastery reward: People's Army, Taj Mahal, Infiltrate Enemy Positions
...
effects:
  - type: UNLOCK
    items: "Demagogy, +1 Settlement Limit"
  - type: MASTERY_REWARD
    effect: "People's Army, Taj Mahal, Infiltrate Enemy Positions"
```
