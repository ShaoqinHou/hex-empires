...
A Modern-Age civic in Civ VII's per-age civic tree. Reform by scientific expertise.
...
- Unlocks: Avant Garde, New Deal, Their Finest Hour
...
effects:
  - type: UNLOCK
    items: "Avant Garde, New Deal, Their Finest Hour"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
