...
A Modern-Age civic in Civ VII's per-age civic tree. Ideology: workers state.
...
- Unlocks: Productive Forces, Proletariat, +3 Ranged, +1 Exp/Sci Attribute
...
effects:
  - type: UNLOCK
    items: "Productive Forces, Proletariat, +3 Ranged, +1 Exp/Sci Attribute"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
