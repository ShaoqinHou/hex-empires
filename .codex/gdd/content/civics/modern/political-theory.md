...
A Modern-Age civic in Civ VII's per-age civic tree. Gates ideology selection.

## Stats / numeric attributes

- Age: modern
- Cost (Culture): 2375
- Prerequisite: modernization, natural-history, social-question
- Unlocks: Free Speech, +1 Policy Slot, Ideology Trees, Doi Suthep
...
effects:
  - type: UNLOCK
    items: "Free Speech, +1 Policy Slot, Ideology Trees, Doi Suthep"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
