# Yankee Ingenuity - Civ VII

**Slug:** `yankee-ingenuity`
**Category:** `civic`
**Age:** `modern`
**Status:** `draft`
**Confidence:** `medium`
...
**Civ-unique: america.** A Modern-Age civic in Civ VII's per-age civic tree. Tinkerer culture becomes industrial edge.
...
- Mastery reward: 25% Gold to purchasing Prospectors
...
effects:
  - type: UNLOCK
    items: "Steel Mill building"
  - type: MASTERY_REWARD
    effect: "25% Gold to purchasing Prospectors"
```
