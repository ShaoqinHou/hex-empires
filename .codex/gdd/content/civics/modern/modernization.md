...
A Modern-Age civic in Civ VII's per-age civic tree. Entry node; industrial reform.
...
- Cost (Culture): 1600
- Prerequisite: none
- Unlocks: Civil Engineering, Living Standards, Hermitage
...
effects:
  - type: UNLOCK
    items: "Civil Engineering, Living Standards, Hermitage"
  - type: MASTERY_REWARD
    effect: "`[none listed]`"
```
