# Noli Me Tangere - Civ VII

**Slug:** `rizal-noli-me-tangere`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.codex/gdd/content/leaders/jose-rizal.md` (parent leader fact card)
- `.codex/gdd/systems/mementos.md` + `.codex/gdd/systems/legends.md`

## Identity

Jose Rizal Leader Path memento. Rizal's anti-colonial novel.

## Stats / numeric attributes

- **Path:** Leader — Jose Rizal
- **Unlock level:** Leader Path L2
- **Effect:** Culture from Museum/Library
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Culture from Museum/Library `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    leader: jose-rizal
    level: 2
    description: "Culture from Museum/Library"
```
