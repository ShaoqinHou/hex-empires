# Florentine Dispatches - Civ VII

**Slug:** `machiavelli-dispatches`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.codex/gdd/content/leaders/machiavelli.md` (parent leader fact card)
- `.codex/gdd/systems/mementos.md` + `.codex/gdd/systems/legends.md`

## Identity

Machiavelli Leader Path memento. Florentine secretary's reports.
