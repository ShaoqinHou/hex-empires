# Xerxes Canal Plaque - Civ VII

**Slug:** `xerxes-kok-canal`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.codex/gdd/content/leaders/xerxes-king-of-kings.md` (parent leader fact card)
- `.codex/gdd/systems/mementos.md` + `.codex/gdd/systems/legends.md`

## Identity

Xerxes King Of Kings Leader Path memento. Engineering of Mount Athos canal.

## Stats / numeric attributes

- **Path:** Leader — Xerxes King Of Kings
- **Unlock level:** Leader Path L9
- **Effect:** Trade Route bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Trade Route bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
