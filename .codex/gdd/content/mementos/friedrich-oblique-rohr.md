# Military Flute - Civ VII

**Slug:** `friedrich-oblique-rohr`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.codex/gdd/content/leaders/friedrich-oblique.md` (parent leader fact card)
- `.codex/gdd/systems/mementos.md` + `.codex/gdd/systems/legends.md`

## Identity

Friedrich Oblique Leader Path memento. Frederick the Great was a musician and composer.

## Stats / numeric attributes

- **Path:** Leader — Friedrich Oblique
- **Unlock level:** Leader Path L9
- **Effect:** Combat initiative bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Combat initiative bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 9
    description: "Combat initiative bonus"
```
