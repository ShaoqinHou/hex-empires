# Miniature Stupa - Civ VII

**Slug:** `ashoka-renouncer-stupa`
**Category:** `memento`
**Age:** `ageless`
**Status:** `draft`
**Confidence:** `medium`
...
- `.codex/gdd/content/leaders/ashoka-world-renouncer.md` (parent leader fact card)
- `.codex/gdd/systems/mementos.md` + `.codex/gdd/systems/legends.md`

## Identity

Ashoka World Renouncer Leader Path memento. Relic-containing Buddhist reliquary mound.

## Stats / numeric attributes

- **Path:** Leader — Ashoka World Renouncer
- **Unlock level:** Leader Path L9
- **Effect:** Religious spread bonus
- **Availability:** equippable on ANY leader once unlocked (cross-leader per VII design)

## Effect description

Pre-game equippable item. Effect persists the whole game. Religious spread bonus `[INFERRED]` exact numeric values may require in-game verification; memento effects in Civ VII combine flat bonuses, conditional triggers, and unit-class modifiers.
...
effects:
  - type: MEMENTO_BONUS
    ...
    level: 9
    description: "Religious spread bonus"
```
