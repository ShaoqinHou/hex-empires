...
|---|---|---|
| Bastion | Defense | Steadfast: +2 CS defending for land units; Bulwark: Fortify 1 turn faster; Hold the Line: +2 CS on Districts; Defilade: +3 CS from Fortifications; Garrison: fortified districts +10 HP; Resolute: +5 HP after attacking (wired) |
