...
| Maneuver | Mobility and flanking | Mobility: +1 movement while on land and ignore terrain restrictions when packed; Harassment: +2 flanking bonus attacking (wired); Redeploy: enemy flanking bonuses -2 attacking units in radius (wired); Amphibious: no embarked attack penalty and 1 movement embark/disembark; Pathfinder: ignore terrain movement restrictions; Area Denial: command radius projects ZoC to enemy land units |
