...
2. Each fortified district must be individually destroyed and captured/controlled.
...
**Status tally:** 11 MATCH / 3 CLOSE / 0 DIVERGED / 0 MISSING / 0 EXTRA
**Audit:** [.codex/gdd/audits/combat.md](../audits/combat.md)
**Highest-severity finding:** F-09 — siege-district-hp-model-partial - (CLOSE, HIGH)
**Convergence status:** Close — 3 numeric/detail adjustment(s) pending
