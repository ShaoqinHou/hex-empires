...
**Status tally:** 1 MATCH / 1 CLOSE / 2 DIVERGED / 5 MISSING / 0 EXTRA
**Audit:** [.codex/gdd/audits/population-specialists.md](../audits/population-specialists.md)
**Highest-severity finding:** F-04 — Specialists tracked city-wide integer, not per-urban-tile map (DIVERGED, HIGH)
