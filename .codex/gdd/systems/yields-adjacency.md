...
**Status tally:** 1 MATCH / 2 CLOSE / 2 DIVERGED / 4 MISSING / 1 EXTRA
**Audit:** [.codex/gdd/audits/yields-adjacency.md](../audits/yields-adjacency.md)
**Highest-severity finding:** F-01 — `YieldSet` has `housing`/`diplomacy` fields; `happiness` absent (DIVERGED, HIGH)
