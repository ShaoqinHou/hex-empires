...
**Status tally:** 5 MATCH / 3 CLOSE / 0 DIVERGED / 0 MISSING / 0 EXTRA
**Audit:** [.codex/gdd/audits/government-policies.md](../audits/government-policies.md)
**Highest-severity finding:** F-05 — Government celebration bonuses missing from GovernmentDef data (CLOSE, HIGH)
