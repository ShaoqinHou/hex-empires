...
**Status tally:** 2 MATCH / 0 CLOSE / 3 DIVERGED / 5 MISSING / 2 EXTRA
**Audit:** [.codex/gdd/audits/buildings-wonders.md](../audits/buildings-wonders.md)
**Highest-severity finding:** F-04 — Quarter formation ignores ageless-pair; `unique_quarter` kind missing (DIVERGED, HIGH)
