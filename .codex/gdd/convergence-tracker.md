...
| commanders | `.codex/gdd/audits/commanders.md` | 10 | 3M / 5C / 0D / 0X / 2E |
...
| commanders | F-03 | `promotion-hooks-partial` | ≈ CLOSE | M | `packages/engine/src/data/commanders/promotion-trees.ts`, `packages/engine/src/t |
