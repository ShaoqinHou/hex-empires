...
Paste into `.codex/gdd/systems/celebrations.md` section "Mapping to hex-empires":
...
**Status:** 1 MATCH / 3 CLOSE / 4 DIVERGED / 5 MISSING / 0 EXTRA (see `.codex/gdd/audits/celebrations.md`)
...
5. Is there a UI design spec for the Celebration bonus choice modal? No panel design doc found in `.codex/workflow/design/`. A designer pass may be needed before F-03 UI work starts.
