...
Audit scope: compare `.codex/gdd/systems/<slug>.md` + `.codex/gdd/content/<cat>/`
...
Paste this back into `.codex/gdd/systems/<slug>.md` § "Mapping to hex-empires":
...
**Status:** N MATCH / N CLOSE / N DIVERGED / N MISSING / N EXTRA (see `.codex/gdd/audits/<slug>.md` for details)
