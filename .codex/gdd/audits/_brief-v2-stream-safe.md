...
Engine files to read (from _engine-file-map.md):
  ...
  - <file 2>
  - ...
Output file: .codex/gdd/audits/<slug>.md (absolute path:
  C:/Users/housh/Documents/monoWeb/hex-empires/.codex/gdd/audits/<slug>.md)
...
correct counts, and append these sections:
    ...
    Paste into `.codex/gdd/systems/<slug>.md` § "Mapping to hex-empires":
...
- `.codex/gdd/_template-strict-agent-brief.md` — the strict BLOCKED-only contract
- `.codex/gdd/audits/_template-audit.md` — the audit output shape
- `.codex/gdd/audits/_engine-file-map.md` — which files to read per system
- `.codex/gdd/audits/audit-process.md` — the audit lifecycle
