...
- Remaining commander promotion hooks (F-03) — Bulwark fortify duration, Looting pillage yield/HP, Survival Training terrain/cliff behavior, Maneuver movement/flanking/amphibious/pathfinding/ZoC behavior, and Leadership command-action behavior.
