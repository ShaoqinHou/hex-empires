...
- Remaining commander promotion hooks (F-03) — Bulwark fortify duration, Garrison fortified-district HP, Recruitment production, Field Medic territory healing, Looting pillage yield/HP, Survival Training terrain/cliff behavior, Maneuver movement/flanking/amphibious/pathfinding/ZoC behavior, and Leadership settlement/command-action behavior.
