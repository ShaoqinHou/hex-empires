...
**Target worktree:** `.codex/worktrees/agent-a1f934de`
...
**Sibling reference:** `.codex/workflow/design/panel-manager-audit.md` (M31) — same
...
| **l** | **Docs + skill: `.codex/rules/hud.md` + `.codex/skills/add-hud-element/SKILL.md`** | Write the ruleset mirroring `.codex/rules/panels.md`. Writes a step-by-step skill for adding a new HUD overlay (choose a positioning strategy, register an id if the manager needs one, wrap in `<TooltipShell>`, test). Final cycle — only docs. | `.codex/rules/hud.md` (new), `.codex/skills/add-hud-element/SKILL.md` (new), `CLAUDE.md` (add HUD section pointer) |
...
`.codex/rules/import-boundaries.md` — it imports React components from `ui/`
