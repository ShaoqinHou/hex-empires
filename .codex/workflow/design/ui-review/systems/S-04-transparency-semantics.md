...
3. **Reviewer rule addition** — `.codex/rules/` gains row: `opacity-raw-alpha | Use a token from opacity-tokens.css; do not inline 0.XX or rgba(..., 0.XX) in components`. Reviewer greps as in #2.
