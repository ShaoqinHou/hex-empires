...
- `.codex/workflow/design/ui-review/08-master-plan.md` §5.1 — source of this phase; §5.3–5.6 consume `DramaModal`.
- `.codex/workflow/design/ui-review/phase-4-chrome-pragmatist.md` — tokens reused (`--panel-bevel-inset`, `--panel-backdrop-modal`).
- `.codex/workflow/design/ui-review/phase-4-chrome-skeptic.md` §4 — failure modes avoided.
- `.codex/workflow/design/ui-review/06-group-e-moments.md` — original moments-of-drama audit.
- `.codex/workflow/design/ui-review/systems/S-07-motion-and-animation.md` — motion tokens for `reveal: "fade"`.
- `.codex/workflow/design/ui-review/systems/S-01-layer-and-zindex.md` — `DramaModal` inherits `--panel-z-modal`; no z-order change.
- `.codex/workflow/design/ui-review/systems/S-06-occlusion-and-dismissal.md` — ESC chain respects `data-dismissible="false"`.
- `.codex/rules/panels.md` — `DramaModal` participates in `PanelManager` identically to `PanelShell(modal)`.
