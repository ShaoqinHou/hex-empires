...
- .codex/workflow/design/ui-review/08-master-plan.md - Phase 4 (strategic dashboards) and Phase 6 (meta chrome cleanup); this spec bundles the chrome portion of both into Phase 4 per loop-state.
- .codex/workflow/design/ui-review/phase-1-design-tokens-spec.md - source of --olive-*, --amber-*, --bronze-*, --cream-* primitives.
...
- .codex/rules/panels.md - token-only chrome rule; chrome-raw-hex-regression trap.
- .codex/rules/ui-overlays.md - sibling HUD chrome would benefit from the same tokens in a future hud-tokens.css follow-up (noted, not scoped).
