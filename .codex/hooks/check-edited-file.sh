#!/bin/bash
# Optional Codex utility for edited TS/TSX files: checks import boundaries.
#
# When invoked by a tool wrapper, the JSON payload may arrive on stdin. Manual
# callers can pipe the same shape: { "file_path": "packages/..." }.
