...
Packages and modules have strict import directions. Violations are checked by
the optional `.codex/hooks/check-edited-file.sh` utility and by lead review.
...
The `.codex/hooks/check-edited-file.sh` utility detects:
