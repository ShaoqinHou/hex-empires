...
The audit motivating this pattern is at `.codex/workflow/design/panel-manager-audit.md`. The full rule set is `.codex/rules/panels.md`. Read those first if you have not.

## Prerequisites

- Familiarity with `.codex/rules/panels.md` (the rules) and `.codex/rules/tech-conventions.md` (no raw hex).
...
- Rules: `.codex/rules/panels.md`
- Audit (15 inconsistencies that motivated the pattern): `.codex/workflow/design/panel-manager-audit.md`
- Implementation:
