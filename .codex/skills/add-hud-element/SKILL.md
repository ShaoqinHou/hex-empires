...
The full rule set is `.codex/rules/ui-overlays.md`. The audit motivating the pattern is `.codex/workflow/design/hud-ui-audit.md`. Read those first if you have not.

## Prerequisites

- Familiarity with `.codex/rules/ui-overlays.md` (the rules) and `.codex/rules/tech-conventions.md` (no raw hex).
- Familiarity with `.codex/rules/panels.md` — the HUD layer mirrors the panel layer's vocabulary.
...
Maintain a running registry of all HUD elements in `.codex/workflow/design/hud-elements.md` (create if missing). One line per element:
...
- [ ] Entry added to `.codex/workflow/design/hud-elements.md`
...
- Rules: `.codex/rules/ui-overlays.md`
- Sibling rules (the panel layer this mirrors): `.codex/rules/panels.md`
- Audit / migration plan: `.codex/workflow/design/hud-ui-audit.md`
- Running catalogue: `.codex/workflow/design/hud-elements.md`
